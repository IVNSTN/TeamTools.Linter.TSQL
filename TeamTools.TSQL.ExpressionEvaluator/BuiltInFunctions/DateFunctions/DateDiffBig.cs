...
{
    public class DateDiffBig : SqlFunctionHandler
    {
        private static readonly int RequiredArgumentCount = 3;
        private static readonly string FuncName = "DATEDIFF_BIG";
        private static readonly string OutputType = TSqlDomainAttributes.Types.BigInt;

        public DateDiffBig() : base(FuncName, RequiredArgumentCount)
        { }
