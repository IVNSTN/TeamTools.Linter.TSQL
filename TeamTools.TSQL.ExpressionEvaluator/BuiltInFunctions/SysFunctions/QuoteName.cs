...
namespace TeamTools.TSQL.ExpressionEvaluator.BuiltInFunctions.SysFunctions
{
    public class QuoteName : SqlGenericFunctionHandler<QuoteName.QuoteNameArgs>
    {
        ...
        private static readonly Dictionary<string, OpenCloseChar> AllowedQuoteChars = new Dictionary<string, OpenCloseChar>(8, StringComparer.OrdinalIgnoreCase);
