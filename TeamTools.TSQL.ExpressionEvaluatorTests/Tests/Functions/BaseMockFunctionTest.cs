...
namespace TeamTools.TSQL.LinterTests.Routines.ExpressionEvaluator
{
    public abstract class BaseMockFunctionTest
    {
        ...
        public virtual void SetUp()
        {
            ...
            var magicValue = new MockSqlValue("INT", SqlValueKind.Precise, new SqlValueSource(SqlValueSourceKind.Literal, null), Factory.TypeHandler);
        ...
        protected SqlStrTypeValue MakeStr(string value)
        {
            return Context.Converter.ImplicitlyConvert<SqlStrTypeValue>(
                Factory.NewLiteral("VARCHAR", value, default));
        }
