        ...
        public void Test_Replace_ApproximatesResultSize()
        {
            var res = func.Evaluate(
                ArgFactory.MakeListOfValues(
                    Factory.NewValue(new SqlStrTypeReference("VARCHAR", 123, Factory), SqlValueKind.Unknown),
                    Factory.NewValue(new SqlStrTypeReference("VARCHAR", 1, Factory), SqlValueKind.Unknown),
                    Factory.NewValue(new SqlStrTypeReference("VARCHAR", 6, Factory), SqlValueKind.Unknown)),
                Context);
