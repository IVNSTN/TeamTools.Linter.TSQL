...
namespace TeamTools.TSQL.LinterTests.Routines.ExpressionEvaluator.TypeHandling
{
    ...
    public sealed class SqlIntTypeHandlerTests : BaseSqlTypeHandlerTestClass
    {
        ...
        public void Test_SqlStrTypeHandler_MakeSqlDataTypeReferenceSavesAllInfo()
        {
            ...
            Assert.That(res.TypeName, Is.EqualTo("TINYINT"));
        ...
        {
            var a = typeHandler.IntValueFactory.MakeApproximateValue("SMALLINT", new SqlIntValueRange(-5, -1), null);
            var b = typeHandler.IntValueFactory.MakeApproximateValue("INT", new SqlIntValueRange(12, 50), null);
