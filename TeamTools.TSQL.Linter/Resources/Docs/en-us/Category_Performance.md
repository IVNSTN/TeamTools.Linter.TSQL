...
# Rules of Performance category

|||
|-|-|
| [PF0130](./PF0130.md) | ROWVERSION / TIMESTAMP index not marked as unique
| [PF0140](./PF0140.md) | Exit if ROWCOUNT=0 not implemented
| [PF0144](./PF0144.md) | NOCOUNT option not set in stored procedure
| [PF0145](./PF0145.md) | NOCOUNT option not set in trigger
| [PF0238](./PF0238.md) | UNION ALL is preferred because one of literals is different in resultsets
...
| [PF0933](./PF0933.md) | CTE used multiple times
| [PF0951](./PF0951.md) | Unexpected sorting of function output
| [PF0952](./PF0952.md) | Unexpected sorting of view output
| [PF0953](./PF0953.md) | TOP limit looks like no limit
| [PF0956](./PF0956.md) | Consider turning filter into SARGable LIKE
