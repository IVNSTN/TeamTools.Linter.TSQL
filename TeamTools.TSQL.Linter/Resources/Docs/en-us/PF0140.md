...
This rule is triggered if the trigger code does not start by checking that the number of rows is non-zero.
<p id="descr">Add a check that the @@ROWCOUNT value is not 0.</p>
