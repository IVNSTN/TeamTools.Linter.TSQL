...
<p id="descr">For optimal performance, avoid using filter predicates in WHERE and JOIN clauses that cannot be efficiently evaluated or applied to existing indexes.</p>
