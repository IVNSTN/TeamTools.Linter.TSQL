...
This rule is triggered when a column value is truncated using `LEFT`, `SUBSTRING` or `CHARINDEX` (when extracting the first character) and compared to a scalar value.
