...
<p id="descr">Правило срабатывает, если в одном и том же запросе в триггере используется INSERTED/DELETED в инструкции OUPUT и специальная таблицы INSERTED/DELETED в инструкции FROM.</p>
