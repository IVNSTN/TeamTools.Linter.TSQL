...
# Курсор, объявленный для изменения колонки, доступной только для чтения
...
Правило срабатывает, если обнаружена попытка изменить с помощью курсора значение колонки, доступной только для чтения.
<p id="descr">Для модификации укажите невычисляемую колонку.</p>
