...
# Несколько столбцов недопустимы в скалярном подзапросе
...
Правило срабатывает, если скалярный подзапрос имеет несколько столбцов для выборки.
<p id="descr">Укажите один столбец в скалярном подзапросе.</p>
