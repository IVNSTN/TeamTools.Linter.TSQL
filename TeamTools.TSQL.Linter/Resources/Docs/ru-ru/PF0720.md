...
<p id="descr">Сортировать результирующий набор в CTE не нужно, так как они встраиваются в другие запросы, где будет итоговая сортировка. Сортировка в CTE либо избыточна, либо может привести к ненадежному решению.</p>
