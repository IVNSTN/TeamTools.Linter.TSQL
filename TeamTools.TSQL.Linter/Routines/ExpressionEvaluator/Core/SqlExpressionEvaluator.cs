...
namespace TeamTools.TSQL.Linter.Routines.ExpressionEvaluator
{
    public class SqlExpressionEvaluator : IExpressionEvaluator
    {
        ...
        {
            this.varEval = variableEvaluator ?? throw new ArgumentNullException(nameof(variableEvaluator));
            this.funcReg = functionRegistry ?? throw new ArgumentNullException(nameof(functionRegistry));
        ...
        public SqlValue EvaluateExpression(ScalarExpression expr)
        {
            ...
            {
                return this.EvaluateFunctionResult(gv.Name, this.ToArgs((IList<ScalarExpression>)null), gv);
            }
