...
namespace TeamTools.TSQL.Linter.Routines.ExpressionEvaluator.TypeHandling
{
    ...
    where TPreciseValue : IComparable<TPreciseValue>
    {
        ...
        public SqlGenericValue(SqlGenericTypeReference<TSize> estimatedSize, SqlValueKind valueKind, SqlValueSource source)
        ...
        public SqlGenericValue(SqlGenericTypeReference<TSize> specificSize, TPreciseValue value, SqlValueSource source)
        : base(specificSize.TypeName, SqlValueKind.Precise, source)
        {
            this.estimatedSize = specificSize;
            this.value = value;
        }
        ...
        private TSize GetEstimatedSize() => estimatedSize == null ? default : estimatedSize.Size;
    }
}
