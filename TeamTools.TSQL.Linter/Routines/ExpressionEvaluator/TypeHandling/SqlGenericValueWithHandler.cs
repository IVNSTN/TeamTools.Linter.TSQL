...
namespace TeamTools.TSQL.Linter.Routines.ExpressionEvaluator.TypeHandling
{
        ...
        where TClone : SqlGenericValueWithHandler<THandler, TValue, TSize, TPreciseValue, TClone>
    {
        ...
        public SqlGenericValueWithHandler(THandler typeHandler, SqlGenericTypeReference<TSize> estimatedSize, SqlValueKind valueKind, SqlValueSource source)
        : base(estimatedSize, valueKind, source)
        {
            this.typeHandler = typeHandler;
        }

        public SqlGenericValueWithHandler(THandler typeHandler, SqlGenericTypeReference<TSize> specificSize, TPreciseValue value, SqlValueSource source)
