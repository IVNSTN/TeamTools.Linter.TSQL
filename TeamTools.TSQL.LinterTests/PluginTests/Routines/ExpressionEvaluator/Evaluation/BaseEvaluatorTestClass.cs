...
namespace TeamTools.TSQL.LinterTests.Routines.ExpressionEvaluator
{
    public abstract class BaseEvaluatorTestClass
    {
        ...
        public virtual void SetUp()
        {
            ...
            Parser = new TSqlParserFactory().Make(150);
            ...
            var strVarTypeRef = new SqlStrTypeReference(
                "dbo.VARCHAR",
                10,
                TypeResolver.ResolveTypeHandler("dbo.VARCHAR").ValueFactory);
            ...
            var intTypeRef = new SqlIntTypeReference(
                    ...
                    TypeResolver.ResolveTypeHandler("dbo.SMALLINT").ValueFactory);
