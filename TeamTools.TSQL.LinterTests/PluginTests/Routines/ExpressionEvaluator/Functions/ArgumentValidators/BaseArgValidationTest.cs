...
namespace TeamTools.TSQL.LinterTests.Routines.ExpressionEvaluator.BuiltInFunctions
{
    public abstract class BaseArgValidationTest
    {
        ...
        public virtual void SetUp()
        {
            ...
            StrValue = strHandler.StrValueFactory.MakePreciseValue("dbo.NVARCHAR", "123", new SqlValueSource(SqlValueSourceKind.Variable, null));
            IntValue = intHandler.IntValueFactory.MakePreciseValue("dbo.TINYINT", 123, new SqlValueSource(SqlValueSourceKind.Expression, null));
        }
