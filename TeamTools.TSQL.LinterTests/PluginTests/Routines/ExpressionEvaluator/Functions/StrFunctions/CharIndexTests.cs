...
namespace TeamTools.TSQL.LinterTests.Routines.ExpressionEvaluator
{
    ...
    public sealed class CharIndexTests : BaseMockFunctionTest
    {
        ...
        public override void SetUp()
        {
            ...
            func = new CharIndex();
            str = Factory.NewLiteral("dbo.VARCHAR", "qwe;rty12;3", default);
            chr = Factory.NewLiteral("dbo.VARCHAR", ";", default);
        }
        ...
        {
            var anotherChar = Factory.NewLiteral("dbo.VARCHAR", "=", default);
        ...
        {
            var pos = Factory.NewLiteral("dbo.INT", "5", default);
