...
namespace TeamTools.TSQL.LinterTests.Routines.ExpressionEvaluator.TypeHandling
{
    ...
    public sealed class SqlBigIntTypeReferenceTests
    {
        ...
        public void Test_SqlBigIntTypeReference_ConstructorFailsOnNullArgs()
        {
            ...
            Assert.Throws(typeof(ArgumentNullException), () => new SqlBigIntTypeReference("dbo.BIGINT", null, factory));
            Assert.Throws(typeof(ArgumentNullException), () => new SqlBigIntTypeReference("dbo.BIGINT", size, null));
        }

        [Test]
        public void Test_SqlBigIntTypeReference_ReturnsCorrectWeight()
        {
            var typeRef = new SqlBigIntTypeReference("dbo.BIGINT", size, factory);
...
#pragma warning disable NUnit2010, NUnit2045
            // same type name
            var a = new SqlBigIntTypeReference("dbo.BIGINT", new SqlBigIntValueRange(-1, 2), factory);
            var b = new SqlBigIntTypeReference("dbo.BIGINT", new SqlBigIntValueRange(100, 200), factory);
