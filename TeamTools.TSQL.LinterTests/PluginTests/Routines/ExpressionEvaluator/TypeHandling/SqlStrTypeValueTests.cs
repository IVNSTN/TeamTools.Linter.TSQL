...
namespace TeamTools.TSQL.LinterTests.Routines.ExpressionEvaluator.TypeHandling
{
    ...
    public sealed class SqlStrTypeValueTests : BaseSqlTypeHandlerTestClass
    {
        ...
        {
            var value = ValueFactory.MakePreciseValue("dbo.CHAR", "asdf", new SqlValueSource(SqlValueSourceKind.Literal, null));
            ...
            Assert.That(nextValue.TypeName, Is.EqualTo("dbo.CHAR"));
        ...
        {
            var value = ValueFactory.MakeApproximateValue("dbo.NVARCHAR", 12, new SqlValueSource(SqlValueSourceKind.Literal, null));
            ...
            Assert.That(nextValue, Is.Not.Null);
            Assert.That(nextValue.TypeName, Is.EqualTo("dbo.NVARCHAR"));
