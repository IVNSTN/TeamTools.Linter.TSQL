...
namespace TeamTools.TSQL.LinterTests
{
    ...
    public abstract class BaseRuleTest
    {
        ...
        private static readonly Regex ExpectedViolationsPattern = new Regex(@".*raise_(?<violations>[\d]+)_violations", RegexOptions.IgnoreCase | RegexOptions.Compiled);
        private MockLinter linterInstance;

        public BaseRuleTest() : base()
        {
