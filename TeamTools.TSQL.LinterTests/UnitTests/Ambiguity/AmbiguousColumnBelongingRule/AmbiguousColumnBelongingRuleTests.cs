...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(AmbiguousColumnBelongingRule))]
    public sealed class AmbiguousColumnBelongingRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(AmbiguousColumnBelongingRuleTests));
        }
    }
}
