...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(AmbiguousUniquenessRule))]
    public sealed class AmbiguousUniquenessRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(AmbiguousUniquenessRuleTests));
        }
    }
}
