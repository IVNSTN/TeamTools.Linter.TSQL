...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ComplexPredicateNegationRule))]
    public sealed class ComplexPredicateNegationRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ComplexPredicateNegationRuleTests));
        }
    }
}
