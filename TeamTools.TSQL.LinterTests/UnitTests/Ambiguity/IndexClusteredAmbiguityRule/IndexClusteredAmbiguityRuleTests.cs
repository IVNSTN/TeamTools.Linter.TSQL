...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IndexClusteredAmbiguityRule))]
    public class IndexClusteredAmbiguityRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IndexClusteredAmbiguityRuleTests));
        }
    }
}
