...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InsertedColumnAliasMatchTargetRule))]
    public class InsertedColumnAliasMatchTargetRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InsertedColumnAliasMatchTargetRuleTests));
        }
    }
}
