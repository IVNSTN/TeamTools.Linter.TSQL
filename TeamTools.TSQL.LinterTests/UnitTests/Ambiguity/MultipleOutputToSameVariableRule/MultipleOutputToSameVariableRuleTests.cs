...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(MultipleOutputToSameVariableRule))]
    public class MultipleOutputToSameVariableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(MultipleOutputToSameVariableRuleTests));
        }
    }
}
