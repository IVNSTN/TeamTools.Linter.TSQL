...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(MultipleVarAssignmentRule))]
    public sealed class MultipleVarAssignmentRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(MultipleVarAssignmentRuleTests));
        }
    }
}
