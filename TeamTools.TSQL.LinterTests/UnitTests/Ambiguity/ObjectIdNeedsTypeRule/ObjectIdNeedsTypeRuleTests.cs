...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ObjectIdNeedsTypeRule))]
    public sealed class ObjectIdNeedsTypeRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ObjectIdNeedsTypeRuleTests));
        }
    }
}
