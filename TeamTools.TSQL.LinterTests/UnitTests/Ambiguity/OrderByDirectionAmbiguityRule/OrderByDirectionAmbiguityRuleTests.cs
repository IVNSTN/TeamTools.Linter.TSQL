...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(OrderByDirectionAmbiguityRule))]
    public class OrderByDirectionAmbiguityRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(OrderByDirectionAmbiguityRuleTests));
        }
    }
}
