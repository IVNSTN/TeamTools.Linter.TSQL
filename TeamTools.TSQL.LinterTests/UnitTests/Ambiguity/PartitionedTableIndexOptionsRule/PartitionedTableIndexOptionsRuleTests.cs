...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(PartitionedTableIndexOptionsRule))]
    public class PartitionedTableIndexOptionsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(PartitionedTableIndexOptionsRuleTests));
        }
    }
}
