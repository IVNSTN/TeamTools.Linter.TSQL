...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ReferencingInsertedDeletedInOutputInTriggerRule))]
    public class ReferencingInsertedDeletedInOutputInTriggerRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ReferencingInsertedDeletedInOutputInTriggerRuleTests));
        }
    }
}
