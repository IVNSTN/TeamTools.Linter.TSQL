...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SchemaQualifiedAlterDropRule))]
    public sealed class SchemaQualifiedAlterDropRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SchemaQualifiedAlterDropRuleTests));
        }
    }
}
