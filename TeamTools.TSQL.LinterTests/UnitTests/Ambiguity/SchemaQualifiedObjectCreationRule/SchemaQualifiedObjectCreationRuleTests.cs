...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SchemaQualifiedObjectCreationRule))]
    public sealed class SchemaQualifiedObjectCreationRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SchemaQualifiedObjectCreationRuleTests));
        }
    }
}
