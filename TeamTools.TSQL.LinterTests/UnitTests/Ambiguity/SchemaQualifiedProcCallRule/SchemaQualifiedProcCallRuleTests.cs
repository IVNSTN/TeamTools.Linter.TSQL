...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SchemaQualifiedProcCallRule))]
    public sealed class SchemaQualifiedProcCallRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SchemaQualifiedProcCallRuleTests));
        }
    }
}
