...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SchemaQualifiedTableReferenceRule))]
    public sealed class SchemaQualifiedTableReferenceRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SchemaQualifiedTableReferenceRuleTests));
        }
    }
}
