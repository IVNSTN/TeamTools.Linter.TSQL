...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(AlwaysEmptyTableAsSourceRule))]
    public class AlwaysEmptyTableAsSourceRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(AlwaysEmptyTableAsSourceRuleTests));
        }
    }
}
