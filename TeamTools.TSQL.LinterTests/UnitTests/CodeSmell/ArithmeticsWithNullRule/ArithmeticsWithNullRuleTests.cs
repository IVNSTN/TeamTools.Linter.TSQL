...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ArithmeticsWithNullRule))]
    public sealed class ArithmeticsWithNullRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ArithmeticsWithNullRuleTests));
        }
    }
}
