...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(BuiltInProcsArgumentOutputRule))]
    public sealed class BuiltInProcsArgumentOutputRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(BuiltInProcsArgumentOutputRuleTests));
        }
    }
}
