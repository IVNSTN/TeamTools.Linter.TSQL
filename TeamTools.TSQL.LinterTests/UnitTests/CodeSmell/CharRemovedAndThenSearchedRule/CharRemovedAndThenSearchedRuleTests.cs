...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(CharRemovedAndThenSearchedRule))]
    public sealed class CharRemovedAndThenSearchedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(CharRemovedAndThenSearchedRuleTests));
        }
    }
}
