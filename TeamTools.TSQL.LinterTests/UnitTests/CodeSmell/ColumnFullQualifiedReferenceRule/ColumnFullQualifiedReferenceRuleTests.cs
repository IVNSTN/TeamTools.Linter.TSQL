...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ColumnFullQualifiedReferenceRule))]
    public class ColumnFullQualifiedReferenceRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ColumnFullQualifiedReferenceRuleTests));
        }
    }
}
