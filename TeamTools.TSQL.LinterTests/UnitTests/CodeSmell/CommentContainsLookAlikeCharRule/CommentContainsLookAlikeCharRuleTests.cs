...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(CommentContainsLookAlikeCharRule))]
    public sealed class CommentContainsLookAlikeCharRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(CommentContainsLookAlikeCharRuleTests));
        }
    }
}
