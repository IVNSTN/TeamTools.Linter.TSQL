...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ComparedExpressionsEqualRule))]
    public class ComparedExpressionsEqualRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ComparedExpressionsEqualRuleTests));
        }
    }
}
