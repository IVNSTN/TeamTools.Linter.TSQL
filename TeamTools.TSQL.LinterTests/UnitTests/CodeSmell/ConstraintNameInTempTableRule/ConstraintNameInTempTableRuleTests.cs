...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ConstraintNameInTempTableRule))]
    public class ConstraintNameInTempTableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ConstraintNameInTempTableRuleTests));
        }
    }
}
