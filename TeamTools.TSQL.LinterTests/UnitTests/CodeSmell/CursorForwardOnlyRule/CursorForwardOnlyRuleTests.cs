...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(CursorForwardOnlyRule))]
    public sealed class CursorForwardOnlyRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(CursorForwardOnlyRuleTests));
        }
    }
}
