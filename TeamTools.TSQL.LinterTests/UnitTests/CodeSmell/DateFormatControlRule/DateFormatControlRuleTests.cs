...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DateFormatControlRule))]
    public sealed class DateFormatControlRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DateFormatControlRuleTests));
        }
    }
}
