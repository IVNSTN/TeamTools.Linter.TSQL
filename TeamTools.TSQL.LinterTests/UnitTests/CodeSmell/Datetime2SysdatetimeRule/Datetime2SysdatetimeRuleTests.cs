...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(Datetime2SysdatetimeRule))]
    public class Datetime2SysdatetimeRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(Datetime2SysdatetimeRuleTests));
        }
    }
}
