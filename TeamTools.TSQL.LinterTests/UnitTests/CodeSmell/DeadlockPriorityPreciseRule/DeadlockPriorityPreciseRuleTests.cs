...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DeadlockPriorityPreciseRule))]
    public sealed class DeadlockPriorityPreciseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DeadlockPriorityPreciseRuleTests));
        }
    }
}
