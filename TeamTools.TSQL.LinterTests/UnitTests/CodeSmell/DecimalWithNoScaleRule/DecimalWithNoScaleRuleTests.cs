...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DecimalWithNoScaleRule))]
    public sealed class DecimalWithNoScaleRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DecimalWithNoScaleRuleTests));
        }
    }
}
