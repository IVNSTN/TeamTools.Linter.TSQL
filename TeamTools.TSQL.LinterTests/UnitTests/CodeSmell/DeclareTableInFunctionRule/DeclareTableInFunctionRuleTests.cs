...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DeclareTableInFunctionRule))]
    public sealed class DeclareTableInFunctionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DeclareTableInFunctionRuleTests));
        }
    }
}
