...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DistinctAfterGroupByRule))]
    public class DistinctAfterGroupByRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DistinctAfterGroupByRuleTests));
        }
    }
}
