...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DistinctForInSubqueryRule))]
    public sealed class DistinctForInSubqueryRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DistinctForInSubqueryRuleTests));
        }
    }
}
