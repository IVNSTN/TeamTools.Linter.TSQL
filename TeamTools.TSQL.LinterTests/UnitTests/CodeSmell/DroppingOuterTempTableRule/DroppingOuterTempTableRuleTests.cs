...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DroppingOuterTempTableRule))]
    public sealed class DroppingOuterTempTableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DroppingOuterTempTableRuleTests));
        }
    }
}
