...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DuplicateConditionRule))]
    public sealed class DuplicateConditionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DuplicateConditionRuleTests));
        }
    }
}
