...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ExtendedPropertyDupRule))]
    public class ExtendedPropertyDupRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ExtendedPropertyDupRuleTests));
        }
    }
}
