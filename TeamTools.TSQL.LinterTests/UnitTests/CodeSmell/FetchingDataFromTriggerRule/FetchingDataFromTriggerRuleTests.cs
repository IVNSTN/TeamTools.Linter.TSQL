...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FetchingDataFromTriggerRule))]
    public class FetchingDataFromTriggerRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FetchingDataFromTriggerRuleTests));
        }
    }
}
