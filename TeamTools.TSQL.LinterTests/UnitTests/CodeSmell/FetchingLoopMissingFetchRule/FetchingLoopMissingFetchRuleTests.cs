...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FetchingLoopMissingFetchRule))]
    public sealed class FetchingLoopMissingFetchRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FetchingLoopMissingFetchRuleTests));
        }
    }
}
