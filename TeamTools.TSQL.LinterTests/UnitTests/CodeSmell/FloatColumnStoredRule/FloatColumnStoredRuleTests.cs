...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FloatColumnStoredRule))]
    public sealed class FloatColumnStoredRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FloatColumnStoredRuleTests));
        }
    }
}
