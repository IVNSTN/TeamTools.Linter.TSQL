...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FloatMixedWithNonFloatRule))]
    public sealed class FloatMixedWithNonFloatRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FloatMixedWithNonFloatRuleTests));
        }
    }
}
