...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FloatVariableUsedRule))]
    public sealed class FloatVariableUsedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FloatVariableUsedRuleTests));
        }
    }
}
