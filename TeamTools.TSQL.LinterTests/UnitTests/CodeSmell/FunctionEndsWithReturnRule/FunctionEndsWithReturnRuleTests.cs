...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FunctionEndsWithReturnRule))]
    public sealed class FunctionEndsWithReturnRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FunctionEndsWithReturnRuleTests));
        }
    }
}
