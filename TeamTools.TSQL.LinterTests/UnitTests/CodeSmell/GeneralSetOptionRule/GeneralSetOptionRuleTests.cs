...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(GeneralSetOptionRule))]
    public sealed class GeneralSetOptionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(GeneralSetOptionRuleTests));
        }
    }
}
