...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(GlobalCursorReferenceRule))]
    public sealed class GlobalCursorReferenceRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(GlobalCursorReferenceRuleTests));
        }
    }
}
