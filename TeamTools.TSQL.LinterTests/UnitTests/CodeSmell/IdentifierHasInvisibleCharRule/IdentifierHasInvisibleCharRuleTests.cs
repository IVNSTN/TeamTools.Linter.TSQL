...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IdentifierHasInvisibleCharRule))]
    public sealed class IdentifierHasInvisibleCharRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IdentifierHasInvisibleCharRuleTests));
        }
    }
}
