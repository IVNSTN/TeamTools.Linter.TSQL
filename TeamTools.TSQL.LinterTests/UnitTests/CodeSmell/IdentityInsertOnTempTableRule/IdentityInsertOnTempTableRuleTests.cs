...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IdentityInsertOnTempTableRule))]
    public sealed class IdentityInsertOnTempTableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IdentityInsertOnTempTableRuleTests));
        }
    }
}
