...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IifWithNestedConditionsToCaseRule))]
    public class IifWithNestedConditionsToCaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IifWithNestedConditionsToCaseRuleTests));
        }
    }
}
