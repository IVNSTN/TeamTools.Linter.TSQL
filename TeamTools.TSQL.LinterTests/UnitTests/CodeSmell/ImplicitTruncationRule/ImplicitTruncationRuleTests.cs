...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ImplicitTruncationRule))]
    public sealed class ImplicitTruncationRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ImplicitTruncationRuleTests));
        }
    }
}
