...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InSelectToExistsRule))]
    public sealed class InSelectToExistsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InSelectToExistsRuleTests));
        }
    }
}
