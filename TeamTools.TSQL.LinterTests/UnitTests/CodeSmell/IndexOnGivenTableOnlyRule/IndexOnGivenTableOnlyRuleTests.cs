...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IndexOnGivenTableOnlyRule))]
    public class IndexOnGivenTableOnlyRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IndexOnGivenTableOnlyRuleTests));
        }
    }
}
