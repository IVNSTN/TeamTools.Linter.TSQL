...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InfiniteLoopHasNoBreakRule))]
    public sealed class InfiniteLoopHasNoBreakRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InfiniteLoopHasNoBreakRuleTests));
        }
    }
}
