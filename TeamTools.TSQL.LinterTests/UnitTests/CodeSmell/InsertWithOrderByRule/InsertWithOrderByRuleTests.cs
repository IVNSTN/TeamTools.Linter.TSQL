...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InsertWithOrderByRule))]
    public sealed class InsertWithOrderByRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InsertWithOrderByRuleTests));
        }
    }
}
