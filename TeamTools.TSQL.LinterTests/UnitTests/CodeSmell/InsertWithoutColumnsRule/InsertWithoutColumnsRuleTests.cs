...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InsertWithoutColumnsRule))]
    public class InsertWithoutColumnsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InsertWithoutColumnsRuleTests));
        }
    }
}
