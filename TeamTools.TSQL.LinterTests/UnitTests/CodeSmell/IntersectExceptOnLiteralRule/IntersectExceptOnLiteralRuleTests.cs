...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IntersectExceptOnLiteralRule))]
    public class IntersectExceptOnLiteralRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IntersectExceptOnLiteralRuleTests));
        }
    }
}
