...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InvariantCaseArgumentRule))]
    public sealed class InvariantCaseArgumentRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InvariantCaseArgumentRuleTests));
        }
    }
}
