...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IsolationLevelContradictionRule))]
    public class IsolationLevelContradictionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IsolationLevelContradictionRuleTests));
        }
    }
}
