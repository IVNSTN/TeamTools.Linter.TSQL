...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IsolationLevelUncommittedRule))]
    public class IsolationLevelUncommittedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IsolationLevelUncommittedRuleTests));
        }
    }
}
