...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(LiteralBrokenUnicodeRule))]
    public sealed class LiteralBrokenUnicodeRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(LiteralBrokenUnicodeRuleTests));
        }
    }
}
