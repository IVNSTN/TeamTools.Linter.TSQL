...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(LiteralContainsLookAlikeCharRule))]
    public sealed class LiteralContainsLookAlikeCharRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(LiteralContainsLookAlikeCharRuleTests));
        }
    }
}
