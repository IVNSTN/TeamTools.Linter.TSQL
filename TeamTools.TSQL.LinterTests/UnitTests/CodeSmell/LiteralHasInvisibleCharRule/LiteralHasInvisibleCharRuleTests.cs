...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(LiteralHasInvisibleCharRule))]
    public sealed class LiteralHasInvisibleCharRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(LiteralHasInvisibleCharRuleTests));
        }
    }
}
