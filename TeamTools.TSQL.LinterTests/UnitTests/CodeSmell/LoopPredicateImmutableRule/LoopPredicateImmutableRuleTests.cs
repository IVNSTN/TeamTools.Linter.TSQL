...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(LoopPredicateImmutableRule))]
    public sealed class LoopPredicateImmutableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(LoopPredicateImmutableRuleTests));
        }
    }
}
