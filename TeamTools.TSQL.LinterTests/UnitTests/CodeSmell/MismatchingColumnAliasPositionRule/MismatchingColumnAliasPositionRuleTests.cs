...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(MismatchingColumnAliasPositionRule))]
    public sealed class MismatchingColumnAliasPositionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(MismatchingColumnAliasPositionRuleTests));
        }
    }
}
