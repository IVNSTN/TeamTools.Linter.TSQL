...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NationalSymbolLossRule))]
    public sealed class NationalSymbolLossRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NationalSymbolLossRuleTests));
        }
    }
}
