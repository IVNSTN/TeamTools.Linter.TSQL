...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NonAnsiNullOperationRule))]
    public class NonAnsiNullOperationRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NonAnsiNullOperationRuleTests));
        }
    }
}
