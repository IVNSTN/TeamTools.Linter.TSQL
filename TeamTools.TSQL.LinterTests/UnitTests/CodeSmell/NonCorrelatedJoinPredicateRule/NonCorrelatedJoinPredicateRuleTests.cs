...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NonCorrelatedJoinPredicateRule))]
    public sealed class NonCorrelatedJoinPredicateRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NonCorrelatedJoinPredicateRuleTests));
        }
    }
}
