...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NumbersHaveNoUnicodeRule))]
    public sealed class NumbersHaveNoUnicodeRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NumbersHaveNoUnicodeRuleTests));
        }
    }
}
