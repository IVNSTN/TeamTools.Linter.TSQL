...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(OutputParameterNeverAssignedRule))]
    public class OutputParameterNeverAssignedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(OutputParameterNeverAssignedRuleTests));
        }
    }
}
