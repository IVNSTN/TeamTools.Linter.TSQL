...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ParameterValueIgnoredRule))]
    public sealed class ParameterValueIgnoredRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ParameterValueIgnoredRuleTests));
        }
    }
}
