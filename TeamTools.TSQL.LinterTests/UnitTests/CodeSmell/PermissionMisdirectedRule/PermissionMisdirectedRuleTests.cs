...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(PermissionMisdirectedRule))]
    public class PermissionMisdirectedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(PermissionMisdirectedRuleTests));
        }
    }
}
