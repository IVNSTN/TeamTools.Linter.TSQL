...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(PositionalProcArgumentsRule))]
    public class PositionalProcArgumentsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(PositionalProcArgumentsRuleTests));
        }
    }
}
