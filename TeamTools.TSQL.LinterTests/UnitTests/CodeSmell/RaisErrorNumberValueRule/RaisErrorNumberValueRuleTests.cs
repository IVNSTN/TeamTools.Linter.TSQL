...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RaisErrorNumberValueRule))]
    public class RaisErrorNumberValueRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RaisErrorNumberValueRuleTests));
        }
    }
}
