...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RaisErrorSeverityValueRule))]
    public class RaisErrorSeverityValueRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RaisErrorSeverityValueRuleTests));
        }
    }
}
