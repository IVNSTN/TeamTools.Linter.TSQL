...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RaisErrorStateValueRule))]
    public class RaisErrorStateValueRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RaisErrorStateValueRuleTests));
        }
    }
}
