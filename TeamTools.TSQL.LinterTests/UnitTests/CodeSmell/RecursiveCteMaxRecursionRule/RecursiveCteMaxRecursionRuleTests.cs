...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RecursiveCteMaxRecursionRule))]
    public sealed class RecursiveCteMaxRecursionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RecursiveCteMaxRecursionRuleTests));
        }
    }
}
