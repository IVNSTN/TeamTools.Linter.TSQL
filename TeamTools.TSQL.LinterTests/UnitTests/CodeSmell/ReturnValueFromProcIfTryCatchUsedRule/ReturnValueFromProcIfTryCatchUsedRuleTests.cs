...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ReturnValueFromProcIfTryCatchUsedRule))]
    public class ReturnValueFromProcIfTryCatchUsedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ReturnValueFromProcIfTryCatchUsedRuleTests));
        }
    }
}
