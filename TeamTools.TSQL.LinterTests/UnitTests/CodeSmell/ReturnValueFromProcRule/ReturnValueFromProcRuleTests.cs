...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ReturnValueFromProcRule))]
    public class ReturnValueFromProcRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ReturnValueFromProcRuleTests));
        }
    }
}
