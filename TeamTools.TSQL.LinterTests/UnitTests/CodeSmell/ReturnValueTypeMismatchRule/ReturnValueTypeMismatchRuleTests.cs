...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ReturnValueTypeMismatchRule))]
    public sealed class ReturnValueTypeMismatchRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ReturnValueTypeMismatchRuleTests));
        }
    }
}
