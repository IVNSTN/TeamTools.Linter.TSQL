...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ReusedCursorNameRule))]
    public sealed class ReusedCursorNameRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ReusedCursorNameRuleTests));
        }
    }
}
