...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ReusedTempTableNameRule))]
    public sealed class ReusedTempTableNameRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ReusedTempTableNameRuleTests));
        }
    }
}
