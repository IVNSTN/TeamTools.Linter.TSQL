...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RowCountAfterNoCountRule))]
    public sealed class RowCountAfterNoCountRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RowCountAfterNoCountRuleTests));
        }
    }
}
