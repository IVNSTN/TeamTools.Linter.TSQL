...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RowVersionMisusedRule))]
    public sealed class RowVersionMisusedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RowVersionMisusedRuleTests));
        }
    }
}
