...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ShowStatisticsFromCodeRule))]
    public class ShowStatisticsFromCodeRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ShowStatisticsFromCodeRuleTests));
        }
    }
}
