...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SparseColInTempTableRule))]
    public sealed class SparseColInTempTableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SparseColInTempTableRuleTests));
        }
    }
}
