...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SuspiciousTranNameRule))]
    public sealed class SuspiciousTranNameRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SuspiciousTranNameRuleTests));
        }
    }
}
