...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SysnameTypeForScalarVariableRule))]
    public class SysnameTypeForScalarVariableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SysnameTypeForScalarVariableRuleTests));
        }
    }
}
