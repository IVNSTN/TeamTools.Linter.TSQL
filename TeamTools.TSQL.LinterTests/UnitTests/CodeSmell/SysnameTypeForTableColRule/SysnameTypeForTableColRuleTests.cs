...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SysnameTypeForTableColRule))]
    public class SysnameTypeForTableColRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SysnameTypeForTableColRuleTests));
        }
    }
}
