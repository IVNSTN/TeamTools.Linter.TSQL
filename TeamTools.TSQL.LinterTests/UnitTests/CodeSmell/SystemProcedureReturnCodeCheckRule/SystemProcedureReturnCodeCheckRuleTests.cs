...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SystemProcedureReturnCodeCheckRule))]
    public class SystemProcedureReturnCodeCheckRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SystemProcedureReturnCodeCheckRuleTests));
        }
    }
}
