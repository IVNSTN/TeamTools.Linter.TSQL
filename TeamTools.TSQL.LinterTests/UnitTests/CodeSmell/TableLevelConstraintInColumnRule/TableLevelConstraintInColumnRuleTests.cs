...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TableLevelConstraintInColumnRule))]
    public class TableLevelConstraintInColumnRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TableLevelConstraintInColumnRuleTests));
        }
    }
}
