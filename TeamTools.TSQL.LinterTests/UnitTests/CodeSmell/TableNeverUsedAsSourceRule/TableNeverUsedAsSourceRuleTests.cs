...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TableNeverUsedAsSourceRule))]
    public class TableNeverUsedAsSourceRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TableNeverUsedAsSourceRuleTests));
        }
    }
}
