...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TableSamplePredictRule))]
    public sealed class TableSamplePredictRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TableSamplePredictRuleTests));
        }
    }
}
