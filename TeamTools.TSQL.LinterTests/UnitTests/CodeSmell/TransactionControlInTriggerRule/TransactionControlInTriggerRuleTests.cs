...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TransactionControlInTriggerRule))]
    public class TransactionControlInTriggerRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TransactionControlInTriggerRuleTests));
        }
    }
}
