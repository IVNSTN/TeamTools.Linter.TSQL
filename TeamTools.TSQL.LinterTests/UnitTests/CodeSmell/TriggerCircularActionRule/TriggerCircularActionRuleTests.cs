...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TriggerCircularActionRule))]
    public class TriggerCircularActionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TriggerCircularActionRuleTests));
        }
    }
}
