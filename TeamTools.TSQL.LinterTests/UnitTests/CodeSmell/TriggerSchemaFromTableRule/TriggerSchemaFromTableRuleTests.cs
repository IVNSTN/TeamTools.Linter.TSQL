...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TriggerSchemaFromTableRule))]
    public sealed class TriggerSchemaFromTableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TriggerSchemaFromTableRuleTests));
        }
    }
}
