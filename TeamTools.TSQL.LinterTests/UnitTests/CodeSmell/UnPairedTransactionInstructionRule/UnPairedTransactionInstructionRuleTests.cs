...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UnPairedTransactionInstructionRule))]
    public sealed class UnPairedTransactionInstructionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UnPairedTransactionInstructionRuleTests));
        }
    }
}
