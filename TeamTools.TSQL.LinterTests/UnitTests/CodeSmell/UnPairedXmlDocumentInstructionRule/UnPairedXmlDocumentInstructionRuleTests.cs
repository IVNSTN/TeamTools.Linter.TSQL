...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UnPairedXmlDocumentInstructionRule))]
    public sealed class UnPairedXmlDocumentInstructionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UnPairedXmlDocumentInstructionRuleTests));
        }
    }
}
