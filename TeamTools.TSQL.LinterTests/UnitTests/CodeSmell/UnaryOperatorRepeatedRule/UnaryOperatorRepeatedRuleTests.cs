...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UnaryOperatorRepeatedRule))]
    public sealed class UnaryOperatorRepeatedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UnaryOperatorRepeatedRuleTests));
        }
    }
}
