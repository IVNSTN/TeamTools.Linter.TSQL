...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UnreliableTypeCheckRule))]
    public sealed class UnreliableTypeCheckRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UnreliableTypeCheckRuleTests));
        }
    }
}
