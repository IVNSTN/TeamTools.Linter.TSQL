...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UserContextControlInTriggerRule))]
    public class UserContextControlInTriggerRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UserContextControlInTriggerRuleTests));
        }
    }
}
