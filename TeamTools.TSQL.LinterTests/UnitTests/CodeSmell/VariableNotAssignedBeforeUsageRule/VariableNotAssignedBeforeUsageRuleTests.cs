...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(VariableNotAssignedBeforeUsageRule))]
    public sealed class VariableNotAssignedBeforeUsageRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(VariableNotAssignedBeforeUsageRuleTests));
        }
    }
}
