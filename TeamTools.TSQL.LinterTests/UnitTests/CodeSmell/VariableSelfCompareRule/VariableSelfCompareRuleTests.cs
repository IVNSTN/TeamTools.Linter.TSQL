...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(VariableSelfCompareRule))]
    public class VariableSelfCompareRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(VariableSelfCompareRuleTests));
        }
    }
}
