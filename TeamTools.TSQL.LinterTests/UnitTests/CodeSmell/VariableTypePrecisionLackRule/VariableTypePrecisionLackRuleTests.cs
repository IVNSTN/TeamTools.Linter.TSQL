...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(VariableTypePrecisionLackRule))]
    public class VariableTypePrecisionLackRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(VariableTypePrecisionLackRuleTests));
        }
    }
}
