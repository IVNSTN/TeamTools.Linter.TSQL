...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(WaitForDelayUsedRule))]
    public sealed class WaitForDelayUsedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(WaitForDelayUsedRuleTests));
        }
    }
}
