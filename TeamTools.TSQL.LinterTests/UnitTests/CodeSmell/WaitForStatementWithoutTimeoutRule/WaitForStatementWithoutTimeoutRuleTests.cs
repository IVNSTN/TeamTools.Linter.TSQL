...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(WaitForStatementWithoutTimeoutRule))]
    public sealed class WaitForStatementWithoutTimeoutRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(WaitForStatementWithoutTimeoutRuleTests));
        }
    }
}
