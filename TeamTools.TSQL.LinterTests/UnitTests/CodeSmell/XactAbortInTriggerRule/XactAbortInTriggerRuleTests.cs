...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(XactAbortInTriggerRule))]
    public sealed class XactAbortInTriggerRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(XactAbortInTriggerRuleTests));
        }
    }
}
