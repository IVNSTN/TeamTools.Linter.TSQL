...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ColumnNullableOptionBeforeConstraintRule))]
    public class ColumnNullableOptionBeforeConstraintRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ColumnNullableOptionBeforeConstraintRuleTests));
        }
    }
}
