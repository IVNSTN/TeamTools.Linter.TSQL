...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ConstraintNameInPersistentTableRule))]
    public class ConstraintNameInPersistentTableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ConstraintNameInPersistentTableRuleTests));
        }
    }
}
