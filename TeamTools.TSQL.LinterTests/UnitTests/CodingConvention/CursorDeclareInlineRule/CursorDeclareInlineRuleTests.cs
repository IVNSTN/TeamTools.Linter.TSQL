...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(CursorDeclareInlineRule))]
    public class CursorDeclareInlineRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(CursorDeclareInlineRuleTests));
        }
    }
}
