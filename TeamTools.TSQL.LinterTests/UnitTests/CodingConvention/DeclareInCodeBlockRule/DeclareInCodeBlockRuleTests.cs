...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DeclareInCodeBlockRule))]
    public sealed class DeclareInCodeBlockRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DeclareInCodeBlockRuleTests));
        }
    }
}
