...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ExistsHasNonLiteralSelectElementRule))]
    public class ExistsHasNonLiteralSelectElementRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ExistsHasNonLiteralSelectElementRuleTests));
        }
    }
}
