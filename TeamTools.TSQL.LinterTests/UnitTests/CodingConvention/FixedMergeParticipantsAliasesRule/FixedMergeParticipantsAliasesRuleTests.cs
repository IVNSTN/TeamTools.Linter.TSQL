...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FixedMergeParticipantsAliasesRule))]
    public class FixedMergeParticipantsAliasesRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FixedMergeParticipantsAliasesRuleTests));
        }
    }
}
