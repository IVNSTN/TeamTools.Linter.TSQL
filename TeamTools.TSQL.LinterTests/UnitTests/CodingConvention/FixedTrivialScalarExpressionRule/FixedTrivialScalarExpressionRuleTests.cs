...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FixedTrivialScalarExpressionRule))]
    public class FixedTrivialScalarExpressionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FixedTrivialScalarExpressionRuleTests));
        }
    }
}
