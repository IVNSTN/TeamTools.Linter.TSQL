...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(GlobalVarUppercaseRule))]
    public sealed class GlobalVarUppercaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(GlobalVarUppercaseRuleTests));
        }
    }
}
