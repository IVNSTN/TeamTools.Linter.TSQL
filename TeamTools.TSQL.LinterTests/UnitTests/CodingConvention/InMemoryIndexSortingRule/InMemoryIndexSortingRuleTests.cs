...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InMemoryIndexSortingRule))]
    public sealed class InMemoryIndexSortingRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InMemoryIndexSortingRuleTests));
        }
    }
}
