...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(KeywordFullOrShortVersionRule))]
    public class KeywordFullOrShortVersionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(KeywordFullOrShortVersionRuleTests));
        }
    }
}
