...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(LeadingSemicolonRule))]
    public sealed class LeadingSemicolonRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(LeadingSemicolonRuleTests));
        }
    }
}
