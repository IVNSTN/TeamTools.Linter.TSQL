...
{
    [Category("Linter.TSQL.CodingConvention")]
    [TestOfRule(typeof(MultipleSingleLineCommentsToMultilineCommentRule))]
    public class MultipleSingleLineCommentsToMultilineCommentRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(MultipleSingleLineCommentsToMultilineCommentRuleTests));
        }
    }
}
