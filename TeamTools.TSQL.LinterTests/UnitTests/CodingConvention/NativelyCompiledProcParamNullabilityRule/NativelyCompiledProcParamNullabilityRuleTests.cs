...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NativelyCompiledProcParamNullabilityRule))]
    public sealed class NativelyCompiledProcParamNullabilityRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NativelyCompiledProcParamNullabilityRuleTests));
        }
    }
}
