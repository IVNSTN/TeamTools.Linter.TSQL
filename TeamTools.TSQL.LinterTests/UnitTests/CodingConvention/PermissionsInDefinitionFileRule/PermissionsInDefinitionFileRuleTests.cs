...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(PermissionsInDefinitionFileRule))]
    public class PermissionsInDefinitionFileRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(PermissionsInDefinitionFileRuleTests));
        }
    }
}
