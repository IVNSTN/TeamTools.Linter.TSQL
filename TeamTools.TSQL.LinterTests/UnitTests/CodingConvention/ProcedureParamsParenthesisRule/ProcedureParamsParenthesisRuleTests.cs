...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ProcedureParamsParenthesisRule))]
    public sealed class ProcedureParamsParenthesisRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ProcedureParamsParenthesisRuleTests));
        }
    }
}
