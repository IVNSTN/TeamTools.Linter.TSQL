...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SemicolonAfterEachStatementRule))]
    public class SemicolonAfterEachStatementRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SemicolonAfterEachStatementRuleTests));
        }
    }
}
