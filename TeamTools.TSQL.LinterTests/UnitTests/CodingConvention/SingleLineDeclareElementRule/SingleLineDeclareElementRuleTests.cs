...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SingleLineDeclareElementRule))]
    public class SingleLineDeclareElementRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SingleLineDeclareElementRuleTests));
        }
    }
}
