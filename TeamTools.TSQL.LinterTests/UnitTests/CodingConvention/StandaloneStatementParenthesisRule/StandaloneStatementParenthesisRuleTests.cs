...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(StandaloneStatementParenthesisRule))]
    public sealed class StandaloneStatementParenthesisRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(StandaloneStatementParenthesisRuleTests));
        }
    }
}
