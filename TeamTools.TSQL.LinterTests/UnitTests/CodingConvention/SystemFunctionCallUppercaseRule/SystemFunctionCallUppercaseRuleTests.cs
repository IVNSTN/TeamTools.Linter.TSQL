...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SystemFunctionCallUppercaseRule))]
    public class SystemFunctionCallUppercaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SystemFunctionCallUppercaseRuleTests));
        }
    }
}
