...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SystemTypeUppercaseRule))]
    public sealed class SystemTypeUppercaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SystemTypeUppercaseRuleTests));
        }
    }
}
