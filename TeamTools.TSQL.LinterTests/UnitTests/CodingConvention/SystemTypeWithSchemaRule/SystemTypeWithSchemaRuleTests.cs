...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SystemTypeWithSchemaRule))]
    public sealed class SystemTypeWithSchemaRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SystemTypeWithSchemaRuleTests));
        }
    }
}
