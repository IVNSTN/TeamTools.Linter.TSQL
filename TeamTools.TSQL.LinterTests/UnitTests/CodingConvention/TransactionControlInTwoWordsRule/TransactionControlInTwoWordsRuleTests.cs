...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TransactionControlInTwoWordsRule))]
    public class TransactionControlInTwoWordsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TransactionControlInTwoWordsRuleTests));
        }
    }
}
