...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UnionScalarsToValuesRule))]
    public class UnionScalarsToValuesRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UnionScalarsToValuesRuleTests));
        }
    }
}
