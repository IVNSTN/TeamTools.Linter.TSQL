...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UserDefinedFunctionInDeclareRule))]
    public class UserDefinedFunctionInDeclareRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UserDefinedFunctionInDeclareRuleTests));
        }
    }
}
