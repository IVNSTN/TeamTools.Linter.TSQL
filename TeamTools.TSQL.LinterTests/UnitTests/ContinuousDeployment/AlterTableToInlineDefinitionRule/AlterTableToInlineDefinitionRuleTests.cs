...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(AlterTableToInlineDefinitionRule))]
    public sealed class AlterTableToInlineDefinitionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(AlterTableToInlineDefinitionRuleTests));
        }
    }
}
