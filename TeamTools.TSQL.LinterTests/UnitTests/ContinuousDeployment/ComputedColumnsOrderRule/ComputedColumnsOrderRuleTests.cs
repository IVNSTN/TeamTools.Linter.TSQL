...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ComputedColumnsOrderRule))]
    public class ComputedColumnsOrderRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ComputedColumnsOrderRuleTests));
        }
    }
}
