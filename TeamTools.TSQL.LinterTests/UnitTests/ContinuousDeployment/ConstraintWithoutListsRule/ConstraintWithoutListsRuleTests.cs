...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ConstraintWithoutListsRule))]
    public class ConstraintWithoutListsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ConstraintWithoutListsRuleTests));
        }
    }
}
