...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(CreateOptionsInsideRule))]
    public sealed class CreateOptionsInsideRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(CreateOptionsInsideRuleTests));
        }
    }
}
