...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DateFunctionsInConstraintRule))]
    public class DateFunctionsInConstraintRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DateFunctionsInConstraintRuleTests));
        }
    }
}
