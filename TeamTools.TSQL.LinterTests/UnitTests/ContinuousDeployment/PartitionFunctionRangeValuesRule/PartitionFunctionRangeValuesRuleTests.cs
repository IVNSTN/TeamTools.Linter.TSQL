...
{
    [Category("Linter.TSQL.ContinuousDeployment")]
    [TestOfRule(typeof(PartitionFunctionRangeValuesRule))]
    public sealed class PartitionFunctionRangeValuesRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(PartitionFunctionRangeValuesRuleTests));
        }
    }
}
