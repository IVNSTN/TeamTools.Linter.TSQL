...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SingleObjectPerFileRule))]
    public class SingleObjectPerFileRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SingleObjectPerFileRuleTests));
        }
    }
}
