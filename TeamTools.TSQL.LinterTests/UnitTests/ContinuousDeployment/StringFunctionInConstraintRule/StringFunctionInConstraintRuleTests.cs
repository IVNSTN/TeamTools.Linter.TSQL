...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(StringFunctionInConstraintRule))]
    public class StringFunctionInConstraintRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(StringFunctionInConstraintRuleTests));
        }
    }
}
