...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(BadLockEscalationForPartitionedTableRule))]
    public sealed class BadLockEscalationForPartitionedTableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(BadLockEscalationForPartitionedTableRuleTests));
        }
    }
}
