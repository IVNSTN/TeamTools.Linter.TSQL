...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(BadTypeForClusteredIndexRule))]
    public sealed class BadTypeForClusteredIndexRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(BadTypeForClusteredIndexRuleTests));
        }
    }
}
