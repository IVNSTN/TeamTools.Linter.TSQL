...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(BloatedClusteredIndexRule))]
    public sealed class BloatedClusteredIndexRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(BloatedClusteredIndexRuleTests));
        }
    }
}
