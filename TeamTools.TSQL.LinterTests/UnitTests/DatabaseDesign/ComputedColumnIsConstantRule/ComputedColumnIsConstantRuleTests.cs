...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ComputedColumnIsConstantRule))]
    public sealed class ComputedColumnIsConstantRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ComputedColumnIsConstantRuleTests));
        }
    }
}
