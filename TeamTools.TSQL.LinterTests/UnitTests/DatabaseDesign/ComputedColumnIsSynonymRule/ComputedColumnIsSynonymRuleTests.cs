...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ComputedColumnIsSynonymRule))]
    public sealed class ComputedColumnIsSynonymRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ComputedColumnIsSynonymRuleTests));
        }
    }
}
