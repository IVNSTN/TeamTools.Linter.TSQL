...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DefaultNullAsStringRule))]
    public sealed class DefaultNullAsStringRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DefaultNullAsStringRuleTests));
        }
    }
}
