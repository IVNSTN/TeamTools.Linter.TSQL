...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ForeignKeyOnMultipleColumnRule))]
    public class ForeignKeyOnMultipleColumnRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ForeignKeyOnMultipleColumnRuleTests));
        }
    }
}
