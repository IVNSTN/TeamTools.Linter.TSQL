...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ForeignKeyOnTempTableRule))]
    public sealed class ForeignKeyOnTempTableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ForeignKeyOnTempTableRuleTests));
        }
    }
}
