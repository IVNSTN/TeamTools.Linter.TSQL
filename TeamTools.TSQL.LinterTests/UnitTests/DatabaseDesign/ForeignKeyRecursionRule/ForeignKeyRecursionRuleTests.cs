...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ForeignKeyRecursionRule))]
    public class ForeignKeyRecursionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ForeignKeyRecursionRuleTests));
        }
    }
}
