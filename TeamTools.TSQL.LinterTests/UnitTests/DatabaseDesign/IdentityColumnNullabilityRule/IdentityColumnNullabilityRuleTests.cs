...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IdentityColumnNullabilityRule))]
    public class IdentityColumnNullabilityRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IdentityColumnNullabilityRuleTests));
        }
    }
}
