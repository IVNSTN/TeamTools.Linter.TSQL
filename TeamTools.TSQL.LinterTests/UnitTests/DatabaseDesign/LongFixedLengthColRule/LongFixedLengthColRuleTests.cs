...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(LongFixedLengthColRule))]
    public sealed class LongFixedLengthColRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(LongFixedLengthColRuleTests));
        }
    }
}
