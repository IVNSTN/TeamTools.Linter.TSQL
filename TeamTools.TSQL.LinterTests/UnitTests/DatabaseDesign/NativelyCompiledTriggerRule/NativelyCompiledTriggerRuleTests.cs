...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NativelyCompiledTriggerRule))]
    public sealed class NativelyCompiledTriggerRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NativelyCompiledTriggerRuleTests));
        }
    }
}
