...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(PrimaryKeyColNullableRule))]
    public class PrimaryKeyColNullableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(PrimaryKeyColNullableRuleTests));
        }
    }
}
