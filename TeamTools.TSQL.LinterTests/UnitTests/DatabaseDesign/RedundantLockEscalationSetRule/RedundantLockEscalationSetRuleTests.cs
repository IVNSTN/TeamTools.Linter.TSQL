...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantLockEscalationSetRule))]
    public sealed class RedundantLockEscalationSetRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantLockEscalationSetRuleTests));
        }
    }
}
