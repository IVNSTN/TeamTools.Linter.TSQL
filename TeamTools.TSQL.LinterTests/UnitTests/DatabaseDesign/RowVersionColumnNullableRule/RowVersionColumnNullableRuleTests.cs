...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RowVersionColumnNullableRule))]
    public class RowVersionColumnNullableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RowVersionColumnNullableRuleTests));
        }
    }
}
