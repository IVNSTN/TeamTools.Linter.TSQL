...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ShortVariableLengthColumnRule))]
    public sealed class ShortVariableLengthColumnRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ShortVariableLengthColumnRuleTests));
        }
    }
}
