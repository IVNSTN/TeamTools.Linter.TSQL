...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SingleColumnTableRule))]
    public sealed class SingleColumnTableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SingleColumnTableRuleTests));
        }
    }
}
