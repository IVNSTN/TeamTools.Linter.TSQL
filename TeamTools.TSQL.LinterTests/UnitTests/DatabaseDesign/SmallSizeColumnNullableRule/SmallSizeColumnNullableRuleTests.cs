...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SmallSizeColumnNullableRule))]
    public sealed class SmallSizeColumnNullableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SmallSizeColumnNullableRuleTests));
        }
    }
}
