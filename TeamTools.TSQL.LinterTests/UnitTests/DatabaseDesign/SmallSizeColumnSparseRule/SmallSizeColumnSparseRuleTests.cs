...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SmallSizeColumnSparseRule))]
    public sealed class SmallSizeColumnSparseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SmallSizeColumnSparseRuleTests));
        }
    }
}
