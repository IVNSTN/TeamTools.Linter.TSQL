...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SmallSizeColumnUnicodeRule))]
    public sealed class SmallSizeColumnUnicodeRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SmallSizeColumnUnicodeRuleTests));
        }
    }
}
