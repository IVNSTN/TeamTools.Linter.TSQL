...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SparseColumnInGeneralRule))]
    public sealed class SparseColumnInGeneralRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SparseColumnInGeneralRuleTests));
        }
    }
}
