...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SparseColumnInMemoryRule))]
    public sealed class SparseColumnInMemoryRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SparseColumnInMemoryRuleTests));
        }
    }
}
