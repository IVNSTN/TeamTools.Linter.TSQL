...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SparseColumnsAsSecondaryRule))]
    public sealed class SparseColumnsAsSecondaryRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SparseColumnsAsSecondaryRuleTests));
        }
    }
}
