...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TableHasNotNullableColumnsRule))]
    public class TableHasNotNullableColumnsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TableHasNotNullableColumnsRuleTests));
        }
    }
}
