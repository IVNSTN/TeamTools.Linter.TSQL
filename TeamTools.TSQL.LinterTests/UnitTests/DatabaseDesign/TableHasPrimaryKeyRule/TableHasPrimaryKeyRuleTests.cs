...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TableHasPrimaryKeyRule))]
    public sealed class TableHasPrimaryKeyRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TableHasPrimaryKeyRuleTests));
        }
    }
}
