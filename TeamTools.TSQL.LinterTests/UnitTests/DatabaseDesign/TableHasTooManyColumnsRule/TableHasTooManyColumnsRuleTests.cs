...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TableHasTooManyColumnsRule))]
    public sealed class TableHasTooManyColumnsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TableHasTooManyColumnsRuleTests));
        }
    }
}
