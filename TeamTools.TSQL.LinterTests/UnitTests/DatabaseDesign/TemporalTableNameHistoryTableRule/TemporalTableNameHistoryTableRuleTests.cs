...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TemporalTableNameHistoryTableRule))]
    public sealed class TemporalTableNameHistoryTableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TemporalTableNameHistoryTableRuleTests));
        }
    }
}
