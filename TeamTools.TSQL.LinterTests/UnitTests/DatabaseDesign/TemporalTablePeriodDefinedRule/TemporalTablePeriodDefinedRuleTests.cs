...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TemporalTablePeriodDefinedRule))]
    public sealed class TemporalTablePeriodDefinedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TemporalTablePeriodDefinedRuleTests));
        }
    }
}
