...
(
    ...
    , sys_start_time    DATETIME2(2)  GENERATED ALWAYS AS ROW START HIDDEN NOT NULL
            CONSTRAINT DF_foo_bar_sys_start_time DEFAULT DATEADD(SECOND,(-(1)), SYSUTCDATETIME())
    , sys_end_time      DATETIME2(2)  GENERATED ALWAYS AS ROW END HIDDEN NOT NULL
            CONSTRAINT DF_foo_bar_sys_end_time DEFAULT CONVERT(DATETIME2(7), '9999-12-31 23:59:59.9999999')
