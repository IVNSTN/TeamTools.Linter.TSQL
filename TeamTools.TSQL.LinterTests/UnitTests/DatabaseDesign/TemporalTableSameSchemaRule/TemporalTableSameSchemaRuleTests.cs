...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TemporalTableSameSchemaRule))]
    public sealed class TemporalTableSameSchemaRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TemporalTableSameSchemaRuleTests));
        }
    }
}
