...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TemporalTableSimilarDateRangePrecision))]
    public sealed class TemporalTableSimilarDateRangePrecisionTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TemporalTableSimilarDateRangePrecisionTests));
        }
    }
}
