...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UidUniquenessQuestionedRule))]
    public sealed class UidUniquenessQuestionedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UidUniquenessQuestionedRuleTests));
        }
    }
}
