...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UniqueColumnInIndexDefinitionRule))]
    public class UniqueColumnInIndexDefinitionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UniqueColumnInIndexDefinitionRuleTests));
        }
    }
}
