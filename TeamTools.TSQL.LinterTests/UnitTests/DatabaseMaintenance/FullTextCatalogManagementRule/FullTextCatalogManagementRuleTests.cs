...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FullTextCatalogManagementRule))]
    public sealed class FullTextCatalogManagementRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FullTextCatalogManagementRuleTests));
        }
    }
}
