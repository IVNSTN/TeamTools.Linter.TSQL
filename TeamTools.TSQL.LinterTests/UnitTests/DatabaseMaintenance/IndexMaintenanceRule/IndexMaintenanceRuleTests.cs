...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IndexMaintenanceRule))]
    public sealed class IndexMaintenanceRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IndexMaintenanceRuleTests));
        }
    }
}
