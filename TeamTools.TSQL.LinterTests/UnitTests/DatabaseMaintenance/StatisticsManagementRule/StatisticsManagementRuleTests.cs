...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(StatisticsManagementRule))]
    public class StatisticsManagementRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(StatisticsManagementRuleTests));
        }
    }
}
