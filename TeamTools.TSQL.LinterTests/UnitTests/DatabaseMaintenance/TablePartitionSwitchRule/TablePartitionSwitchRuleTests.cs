...
{
    [Category("Linter.TSQL.DatabaseMaintenance")]
    [TestOfRule(typeof(TablePartitionSwitchRule))]
    public class TablePartitionSwitchRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TablePartitionSwitchRuleTests));
        }
    }
}
