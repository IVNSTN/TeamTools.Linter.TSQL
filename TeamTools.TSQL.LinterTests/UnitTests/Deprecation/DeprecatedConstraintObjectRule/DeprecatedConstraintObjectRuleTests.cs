...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DeprecatedConstraintObjectRule))]
    public class DeprecatedConstraintObjectRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DeprecatedConstraintObjectRuleTests));
        }
    }
}
