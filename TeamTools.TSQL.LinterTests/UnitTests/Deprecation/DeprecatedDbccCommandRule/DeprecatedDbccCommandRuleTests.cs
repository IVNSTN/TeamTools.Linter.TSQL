...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DeprecatedDbccCommandRule))]
    public class DeprecatedDbccCommandRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DeprecatedDbccCommandRuleTests));
        }
    }
}
