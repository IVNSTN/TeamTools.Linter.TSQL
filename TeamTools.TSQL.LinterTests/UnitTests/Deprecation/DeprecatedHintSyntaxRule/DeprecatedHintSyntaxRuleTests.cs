...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DeprecatedHintSyntaxRule))]
    public class DeprecatedHintSyntaxRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DeprecatedHintSyntaxRuleTests));
        }
    }
}
