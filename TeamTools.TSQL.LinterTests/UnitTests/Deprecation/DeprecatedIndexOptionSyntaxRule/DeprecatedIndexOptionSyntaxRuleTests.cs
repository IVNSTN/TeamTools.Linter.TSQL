...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DeprecatedIndexOptionSyntaxRule))]
    public sealed class DeprecatedIndexOptionSyntaxRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DeprecatedIndexOptionSyntaxRuleTests));
        }
    }
}
