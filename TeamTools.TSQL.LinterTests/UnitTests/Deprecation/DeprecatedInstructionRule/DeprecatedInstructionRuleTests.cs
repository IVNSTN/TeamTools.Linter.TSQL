...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DeprecatedInstructionRule))]
    public class DeprecatedInstructionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DeprecatedInstructionRuleTests));
        }
    }
}
