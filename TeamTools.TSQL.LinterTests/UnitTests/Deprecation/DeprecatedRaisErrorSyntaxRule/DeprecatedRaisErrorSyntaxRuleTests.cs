...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DeprecatedRaisErrorSyntaxRule))]
    public sealed class DeprecatedRaisErrorSyntaxRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DeprecatedRaisErrorSyntaxRuleTests));
        }
    }
}
