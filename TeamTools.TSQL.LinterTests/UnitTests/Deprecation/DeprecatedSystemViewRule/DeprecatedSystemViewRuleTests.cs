...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DeprecatedSystemViewRule))]
    public sealed class DeprecatedSystemViewRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DeprecatedSystemViewRuleTests));
        }
    }
}
