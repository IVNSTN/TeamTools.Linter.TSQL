...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DeprecatedTopSyntaxRule))]
    public sealed class DeprecatedTopSyntaxRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DeprecatedTopSyntaxRuleTests));
        }
    }
}
