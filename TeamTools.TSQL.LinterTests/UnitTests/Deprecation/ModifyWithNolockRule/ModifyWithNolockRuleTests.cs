...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ModifyWithNolockRule))]
    public sealed class ModifyWithNolockRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ModifyWithNolockRuleTests));
        }
    }
}
