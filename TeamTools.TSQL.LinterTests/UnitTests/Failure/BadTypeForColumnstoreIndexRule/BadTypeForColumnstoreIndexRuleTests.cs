...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(BadTypeForColumnstoreIndexRule))]
    public sealed class BadTypeForColumnstoreIndexRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(BadTypeForColumnstoreIndexRuleTests));
        }
    }
}
