...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(BuiltInFunctionsArgumentCountRule))]
    public class BuiltInFunctionsArgumentCountRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(BuiltInFunctionsArgumentCountRuleTests));
        }
    }
}
