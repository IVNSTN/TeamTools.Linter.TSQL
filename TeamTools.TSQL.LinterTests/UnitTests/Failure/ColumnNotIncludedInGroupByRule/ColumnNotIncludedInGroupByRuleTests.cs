...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ColumnNotIncludedInGroupByRule))]
    public sealed class ColumnNotIncludedInGroupByRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ColumnNotIncludedInGroupByRuleTests));
        }
    }
}
