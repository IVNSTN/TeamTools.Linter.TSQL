...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(CursorFetchColCountRule))]
    public class CursorFetchColCountRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(CursorFetchColCountRuleTests));
        }
    }
}
