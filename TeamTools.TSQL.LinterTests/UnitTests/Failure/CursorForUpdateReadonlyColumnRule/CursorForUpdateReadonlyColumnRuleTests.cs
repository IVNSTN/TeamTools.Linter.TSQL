...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(CursorForUpdateReadonlyColumnRule))]
    public sealed class CursorForUpdateReadonlyColumnRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(CursorForUpdateReadonlyColumnRuleTests));
        }
    }
}
