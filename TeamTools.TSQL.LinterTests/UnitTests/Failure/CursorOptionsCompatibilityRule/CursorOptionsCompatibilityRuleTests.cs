...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(CursorOptionsCompatibilityRule))]
    public class CursorOptionsCompatibilityRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(CursorOptionsCompatibilityRuleTests));
        }
    }
}
