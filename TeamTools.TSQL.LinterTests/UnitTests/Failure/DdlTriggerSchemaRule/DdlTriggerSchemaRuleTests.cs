...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DdlTriggerSchemaRule))]
    public sealed class DdlTriggerSchemaRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DdlTriggerSchemaRuleTests));
        }
    }
}
