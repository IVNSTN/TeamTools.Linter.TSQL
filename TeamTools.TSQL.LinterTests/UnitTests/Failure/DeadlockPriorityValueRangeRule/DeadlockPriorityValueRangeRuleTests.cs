...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DeadlockPriorityValueRangeRule))]
    public sealed class DeadlockPriorityValueRangeRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DeadlockPriorityValueRangeRuleTests));
        }
    }
}
