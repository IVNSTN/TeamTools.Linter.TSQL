...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DuplicateColInTableDefinitionRule))]
    public sealed class DuplicateColInTableDefinitionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DuplicateColInTableDefinitionRuleTests));
        }
    }
}
