...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FormatArgumentCountMismatchRule))]
    public class FormatArgumentCountMismatchRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FormatArgumentCountMismatchRuleTests));
        }
    }
}
