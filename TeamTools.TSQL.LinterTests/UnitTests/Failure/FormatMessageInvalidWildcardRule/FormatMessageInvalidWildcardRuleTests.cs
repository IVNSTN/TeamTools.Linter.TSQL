...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FormatMessageInvalidWildcardRule))]
    public class FormatMessageInvalidWildcardRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FormatMessageInvalidWildcardRuleTests));
        }
    }
}
