...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FunctionHasIllegalCodeRule))]
    public sealed class FunctionHasIllegalCodeRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FunctionHasIllegalCodeRuleTests));
        }
    }
}
