...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ImplicitConversionImpossibleRule))]
    public sealed class ImplicitConversionImpossibleRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ImplicitConversionImpossibleRuleTests));
        }
    }
}
