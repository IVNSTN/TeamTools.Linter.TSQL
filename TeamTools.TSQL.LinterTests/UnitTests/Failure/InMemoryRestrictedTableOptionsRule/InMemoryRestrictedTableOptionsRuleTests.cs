...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InMemoryRestrictedTableOptionsRule))]
    public sealed class InMemoryRestrictedTableOptionsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InMemoryRestrictedTableOptionsRuleTests));
        }
    }
}
