...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IncompatibleIndexOptionRule))]
    public sealed class IncompatibleIndexOptionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IncompatibleIndexOptionRuleTests));
        }
    }
}
