...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IndexReferencingUnknownColumnRule))]
    public class IndexReferencingUnknownColumnRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IndexReferencingUnknownColumnRuleTests));
        }
    }
}
