...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InsertMissesRequiredColumnRule))]
    public sealed class InsertMissesRequiredColumnRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InsertMissesRequiredColumnRuleTests));
        }
    }
}
