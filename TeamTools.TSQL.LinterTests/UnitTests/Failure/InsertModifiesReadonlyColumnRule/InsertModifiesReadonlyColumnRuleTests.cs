...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InsertModifiesReadonlyColumnRule))]
    public sealed class InsertModifiesReadonlyColumnRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InsertModifiesReadonlyColumnRuleTests));
        }
    }
}
