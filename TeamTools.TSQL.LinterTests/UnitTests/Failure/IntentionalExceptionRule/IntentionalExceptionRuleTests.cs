...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IntentionalExceptionRule))]
    public sealed class IntentionalExceptionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IntentionalExceptionRuleTests));
        }
    }
}
