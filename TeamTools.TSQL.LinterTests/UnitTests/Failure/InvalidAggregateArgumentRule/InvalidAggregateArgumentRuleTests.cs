...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InvalidAggregateArgumentRule))]
    public sealed class InvalidAggregateArgumentRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InvalidAggregateArgumentRuleTests));
        }
    }
}
