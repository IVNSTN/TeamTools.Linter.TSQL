...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InvalidClrOptionRule))]
    public sealed class InvalidClrOptionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InvalidClrOptionRuleTests));
        }
    }
}
