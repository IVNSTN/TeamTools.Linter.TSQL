...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InvalidFunctionArgumentCountRule))]
    public sealed class InvalidFunctionArgumentCountRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InvalidFunctionArgumentCountRuleTests));
        }
    }
}
