...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InvalidFunctionArgumentRule))]
    public sealed class InvalidFunctionArgumentRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InvalidFunctionArgumentRuleTests));
        }
    }
}
