...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InvalidTypeForNumericOperationRule))]
    public sealed class InvalidTypeForNumericOperationRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InvalidTypeForNumericOperationRuleTests));
        }
    }
}
