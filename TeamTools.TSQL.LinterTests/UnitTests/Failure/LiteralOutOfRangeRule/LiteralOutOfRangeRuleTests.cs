...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(LiteralOutOfRangeRule))]
    public sealed class LiteralOutOfRangeRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(LiteralOutOfRangeRuleTests));
        }
    }
}
