...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NativelyCompiledNeedsSchemabindingRule))]
    public sealed class NativelyCompiledNeedsSchemabindingRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NativelyCompiledNeedsSchemabindingRuleTests));
        }
    }
}
