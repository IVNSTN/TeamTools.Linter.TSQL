...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NativelyUnsupportedFunctionCallRule))]
    public sealed class NativelyUnsupportedFunctionCallRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NativelyUnsupportedFunctionCallRuleTests));
        }
    }
}
