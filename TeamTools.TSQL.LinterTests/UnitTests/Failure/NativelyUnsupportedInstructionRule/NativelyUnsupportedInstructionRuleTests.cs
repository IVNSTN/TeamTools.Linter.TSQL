...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NativelyUnsupportedInstructionRule))]
    public sealed class NativelyUnsupportedInstructionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NativelyUnsupportedInstructionRuleTests));
        }
    }
}
