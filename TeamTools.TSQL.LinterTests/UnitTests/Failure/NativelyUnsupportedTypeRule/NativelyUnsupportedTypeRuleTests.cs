...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NativelyUnsupportedTypeRule))]
    public sealed class NativelyUnsupportedTypeRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NativelyUnsupportedTypeRuleTests));
        }
    }
}
