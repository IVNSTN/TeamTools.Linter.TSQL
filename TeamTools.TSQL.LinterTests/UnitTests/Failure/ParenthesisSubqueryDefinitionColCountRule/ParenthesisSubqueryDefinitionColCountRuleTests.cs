...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ParenthesisSubqueryDefinitionColCountRule))]
    public class ParenthesisSubqueryDefinitionColCountRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ParenthesisSubqueryDefinitionColCountRuleTests));
        }
    }
}
