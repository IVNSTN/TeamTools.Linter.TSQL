...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RaiseErrorNeedsWithLogRule))]
    public class RaiseErrorNeedsWithLogRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RaiseErrorNeedsWithLogRuleTests));
        }
    }
}
