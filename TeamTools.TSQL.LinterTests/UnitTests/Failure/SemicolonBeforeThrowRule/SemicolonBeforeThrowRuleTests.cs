...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SemicolonBeforeThrowRule))]
    public class SemicolonBeforeThrowRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SemicolonBeforeThrowRuleTests));
        }
    }
}
