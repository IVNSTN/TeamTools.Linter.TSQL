...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SetOptionInFunctionRule))]
    public class SetOptionInFunctionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SetOptionInFunctionRuleTests));
        }
    }
}
