...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SpExecuteParamDefinitionMatchRule))]
    public class SpExecuteParamDefinitionMatchRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SpExecuteParamDefinitionMatchRuleTests));
        }
    }
}
