...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SpExecuteSqlNoAsciiSupportRule))]
    public sealed class SpExecuteSqlNoAsciiSupportRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SpExecuteSqlNoAsciiSupportRuleTests));
        }
    }
}
