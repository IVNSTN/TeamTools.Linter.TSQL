...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SparseCannotBeKeyRule))]
    public sealed class SparseCannotBeKeyRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SparseCannotBeKeyRuleTests));
        }
    }
}
