...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SparseUnsupportedFeatureRule))]
    public sealed class SparseUnsupportedFeatureRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SparseUnsupportedFeatureRuleTests));
        }
    }
}
