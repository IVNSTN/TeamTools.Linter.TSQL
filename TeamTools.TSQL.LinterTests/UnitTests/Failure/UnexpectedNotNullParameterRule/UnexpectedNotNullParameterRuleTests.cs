...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UnexpectedNotNullParameterRule))]
    public sealed class UnexpectedNotNullParameterRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UnexpectedNotNullParameterRuleTests));
        }
    }
}
