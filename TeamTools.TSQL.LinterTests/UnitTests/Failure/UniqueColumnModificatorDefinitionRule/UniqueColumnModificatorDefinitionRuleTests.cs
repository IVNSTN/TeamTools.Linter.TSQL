...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UniqueColumnModificatorDefinitionRule))]
    public class UniqueColumnModificatorDefinitionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UniqueColumnModificatorDefinitionRuleTests));
        }
    }
}
