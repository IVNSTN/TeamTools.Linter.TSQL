...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UnknownIdentifierRule))]
    public sealed class UnknownIdentifierRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UnknownIdentifierRuleTests));
        }
    }
}
