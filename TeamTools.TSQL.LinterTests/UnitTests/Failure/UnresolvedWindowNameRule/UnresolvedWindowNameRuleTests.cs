...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UnresolvedWindowNameRule))]
    public sealed class UnresolvedWindowNameRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UnresolvedWindowNameRuleTests));
        }
    }
}
