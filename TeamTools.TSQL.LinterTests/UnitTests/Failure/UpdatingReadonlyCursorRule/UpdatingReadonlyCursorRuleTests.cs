...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UpdatingReadonlyCursorRule))]
    public sealed class UpdatingReadonlyCursorRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UpdatingReadonlyCursorRuleTests));
        }
    }
}
