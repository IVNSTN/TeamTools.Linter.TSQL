...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FileNameMatchesObjectNameRule))]
    public sealed class FileNameMatchesObjectNameRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FileNameMatchesObjectNameRuleTests));
        }
    }
}
