...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FileNameSquareBracketsRule))]
    public sealed class FileNameSquareBracketsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FileNameSquareBracketsRuleTests));
        }
    }
}
