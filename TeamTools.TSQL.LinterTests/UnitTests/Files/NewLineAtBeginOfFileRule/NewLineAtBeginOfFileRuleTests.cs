...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NewLineAtBeginOfFileRule))]
    public class NewLineAtBeginOfFileRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NewLineAtBeginOfFileRuleTests));
        }
    }
}
