...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DanglingSemicolonRule))]
    public sealed class DanglingSemicolonRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DanglingSemicolonRuleTests));
        }
    }
}
