...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DeclareFormatAsTableRule))]
    public class DeclareFormatAsTableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DeclareFormatAsTableRuleTests));
        }
    }
}
