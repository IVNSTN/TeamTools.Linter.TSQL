...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(GarbageBeforeSemicolonRule))]
    public sealed class GarbageBeforeSemicolonRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(GarbageBeforeSemicolonRuleTests));
        }
    }
}
