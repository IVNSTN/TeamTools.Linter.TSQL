...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(JoinParenthesisAlignedToFromRule))]
    public class JoinParenthesisAlignedToFromRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(JoinParenthesisAlignedToFromRuleTests));
        }
    }
}
