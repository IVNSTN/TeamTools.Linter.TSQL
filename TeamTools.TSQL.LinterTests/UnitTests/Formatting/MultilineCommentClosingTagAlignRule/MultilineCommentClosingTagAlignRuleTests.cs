...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(MultilineCommentClosingTagAlignRule))]
    public class MultilineCommentClosingTagAlignRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(MultilineCommentClosingTagAlignRuleTests));
        }
    }
}
