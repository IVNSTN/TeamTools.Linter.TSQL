...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(MultilineCommentOpenCloseTagAlignRule))]
    public class MultilineCommentOpenCloseTagAlignRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(MultilineCommentOpenCloseTagAlignRuleTests));
        }
    }
}
