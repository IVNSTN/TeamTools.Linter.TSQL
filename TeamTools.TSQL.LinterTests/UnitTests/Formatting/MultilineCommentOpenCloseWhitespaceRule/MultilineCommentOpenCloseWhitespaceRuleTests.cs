...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(MultilineCommentOpenCloseWhitespaceRule))]
    public class MultilineCommentOpenCloseWhitespaceRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(MultilineCommentOpenCloseWhitespaceRuleTests));
        }
    }
}
