...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(MultipleSingleLineCommentsAlignRule))]
    public class MultipleSingleLineCommentsAlignRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(MultipleSingleLineCommentsAlignRuleTests));
        }
    }
}
