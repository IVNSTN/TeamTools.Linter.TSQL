...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NestedBeginEndAlignLeftMarginRule))]
    public class NestedBeginEndAlignLeftMarginRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NestedBeginEndAlignLeftMarginRuleTests));
        }
    }
}
