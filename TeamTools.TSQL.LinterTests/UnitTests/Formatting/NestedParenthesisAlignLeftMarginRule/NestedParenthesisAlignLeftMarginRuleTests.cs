...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NestedParenthesisAlignLeftMarginRule))]
    public class NestedParenthesisAlignLeftMarginRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NestedParenthesisAlignLeftMarginRuleTests));
        }
    }
}
