...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(OpenCloseParenthesisAlignRule))]
    public class OpenCloseParenthesisAlignRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(OpenCloseParenthesisAlignRuleTests));
        }
    }
}
