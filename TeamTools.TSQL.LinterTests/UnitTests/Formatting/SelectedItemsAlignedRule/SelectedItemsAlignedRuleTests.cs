...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SelectedItemsAlignedRule))]
    public class SelectedItemsAlignedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SelectedItemsAlignedRuleTests));
        }
    }
}
