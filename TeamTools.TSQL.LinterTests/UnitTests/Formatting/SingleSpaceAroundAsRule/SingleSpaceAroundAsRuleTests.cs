...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SingleSpaceAroundAsRule))]
    public class SingleSpaceAroundAsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SingleSpaceAroundAsRuleTests));
        }
    }
}
