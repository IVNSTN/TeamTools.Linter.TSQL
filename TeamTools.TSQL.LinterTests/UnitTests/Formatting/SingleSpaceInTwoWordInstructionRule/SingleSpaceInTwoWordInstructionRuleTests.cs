...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SingleSpaceInTwoWordInstructionRule))]
    public class SingleSpaceInTwoWordInstructionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SingleSpaceInTwoWordInstructionRuleTests));
        }
    }
}
