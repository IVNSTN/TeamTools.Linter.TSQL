...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SpaceBeforeTypeSizeRule))]
    public sealed class SpaceBeforeTypeSizeRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SpaceBeforeTypeSizeRuleTests));
        }
    }
}
