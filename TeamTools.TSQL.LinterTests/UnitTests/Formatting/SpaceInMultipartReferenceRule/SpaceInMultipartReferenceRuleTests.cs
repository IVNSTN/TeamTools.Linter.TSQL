...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SpaceInMultipartReferenceRule))]
    public sealed class SpaceInMultipartReferenceRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SpaceInMultipartReferenceRuleTests));
        }
    }
}
