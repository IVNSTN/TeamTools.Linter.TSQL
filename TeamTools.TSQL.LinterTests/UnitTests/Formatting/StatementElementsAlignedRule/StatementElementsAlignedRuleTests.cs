...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(StatementElementsAlignedRule))]
    public sealed class StatementElementsAlignedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(StatementElementsAlignedRuleTests));
        }
    }
}
