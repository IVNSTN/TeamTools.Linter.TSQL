...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TrailingSpacesInCommentsRule))]
    public class TrailingSpacesInCommentsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TrailingSpacesInCommentsRuleTests));
        }
    }
}
