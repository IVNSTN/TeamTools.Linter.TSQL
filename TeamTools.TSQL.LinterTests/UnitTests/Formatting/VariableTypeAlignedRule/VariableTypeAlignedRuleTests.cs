...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(VariableTypeAlignedRule))]
    public class VariableTypeAlignedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(VariableTypeAlignedRuleTests));
        }
    }
}
