...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(WhitespaceAfterCommaRule))]
    public class WhitespaceAfterCommaRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(WhitespaceAfterCommaRuleTests));
        }
    }
}
