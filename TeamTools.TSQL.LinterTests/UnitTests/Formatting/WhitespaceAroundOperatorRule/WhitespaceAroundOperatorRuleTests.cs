...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(WhitespaceAroundOperatorRule))]
    public class WhitespaceAroundOperatorRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(WhitespaceAroundOperatorRuleTests));
        }
    }
}
