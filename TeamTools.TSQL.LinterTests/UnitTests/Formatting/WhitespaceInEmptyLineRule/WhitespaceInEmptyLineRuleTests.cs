...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(WhitespaceInEmptyLineRule))]
    public class WhitespaceInEmptyLineRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(WhitespaceInEmptyLineRuleTests));
        }
    }
}
