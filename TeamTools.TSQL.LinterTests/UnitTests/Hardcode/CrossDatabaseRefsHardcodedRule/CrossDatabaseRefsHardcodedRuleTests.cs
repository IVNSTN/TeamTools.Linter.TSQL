...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(CrossDatabaseRefsHardcodedRule))]
    public class CrossDatabaseRefsHardcodedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(CrossDatabaseRefsHardcodedRuleTests));
        }
    }
}
