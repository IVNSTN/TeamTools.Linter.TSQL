...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IndexFileGroupNonPrimaryRule))]
    public class IndexFileGroupNonPrimaryRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IndexFileGroupNonPrimaryRuleTests));
        }
    }
}
