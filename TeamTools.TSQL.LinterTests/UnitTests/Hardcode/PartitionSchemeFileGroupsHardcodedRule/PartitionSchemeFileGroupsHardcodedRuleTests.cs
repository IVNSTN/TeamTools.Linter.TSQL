...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(PartitionSchemeFileGroupsHardcodedRule))]
    public class PartitionSchemeFileGroupsHardcodedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(PartitionSchemeFileGroupsHardcodedRuleTests));
        }
    }
}
