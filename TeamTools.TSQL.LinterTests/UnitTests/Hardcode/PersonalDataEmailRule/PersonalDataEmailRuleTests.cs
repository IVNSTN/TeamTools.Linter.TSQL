...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(PersonalDataEmailRule))]
    public sealed class PersonalDataEmailRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(PersonalDataEmailRuleTests));
        }
    }
}
