...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(PersonalDataPhoneRule))]
    public sealed class PersonalDataPhoneRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(PersonalDataPhoneRuleTests));
        }
    }
}
