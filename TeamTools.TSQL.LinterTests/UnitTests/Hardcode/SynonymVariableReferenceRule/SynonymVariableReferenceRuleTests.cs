...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SynonymVariableReferenceRule))]
    public sealed class SynonymVariableReferenceRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SynonymVariableReferenceRuleTests));
        }
    }
}
