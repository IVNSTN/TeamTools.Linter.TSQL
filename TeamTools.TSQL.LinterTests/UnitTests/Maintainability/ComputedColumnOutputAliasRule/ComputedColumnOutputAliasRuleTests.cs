...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ComputedColumnOutputAliasRule))]
    public class ComputedColumnOutputAliasRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ComputedColumnOutputAliasRuleTests));
        }
    }
}
