...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(InPredicateTooManyValuesRule))]
    public sealed class InPredicateTooManyValuesRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(InPredicateTooManyValuesRuleTests));
        }
    }
}
