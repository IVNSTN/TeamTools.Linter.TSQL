...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ProgrammabilityHasManyArgsRule))]
    public sealed class ProgrammabilityHasManyArgsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ProgrammabilityHasManyArgsRuleTests));
        }
    }
}
