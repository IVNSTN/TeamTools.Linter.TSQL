...
{
    [Category("Linter.TSQL.Maintainability")]
    [TestOfRule(typeof(ProgrammabilityHasZeroArgsRule))]
    public sealed class ProgrammabilityHasZeroArgsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ProgrammabilityHasZeroArgsRuleTests));
        }
    }
}
