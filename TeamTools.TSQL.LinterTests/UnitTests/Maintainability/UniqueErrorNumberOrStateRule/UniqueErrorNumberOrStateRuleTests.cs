...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UniqueErrorNumberOrStateRule))]
    public class UniqueErrorNumberOrStateRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UniqueErrorNumberOrStateRuleTests));
        }
    }
}
