...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(AlphabetMixInIdentifierRule))]
    public class AlphabetMixInIdentifierRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(AlphabetMixInIdentifierRuleTests));
        }
    }
}
