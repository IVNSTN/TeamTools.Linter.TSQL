...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ConstraintNameFormatRule))]
    public class ConstraintNameFormatRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ConstraintNameFormatRuleTests));
        }
    }
}
