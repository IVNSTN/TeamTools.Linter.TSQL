...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FieldNameCamelCaseRule))]
    public sealed class FieldNameCamelCaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FieldNameCamelCaseRuleTests));
        }
    }
}
