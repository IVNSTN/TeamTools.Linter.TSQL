...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FieldNameLowerSnakeCaseRule))]
    public sealed class FieldNameLowerSnakeCaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FieldNameLowerSnakeCaseRuleTests));
        }
    }
}
