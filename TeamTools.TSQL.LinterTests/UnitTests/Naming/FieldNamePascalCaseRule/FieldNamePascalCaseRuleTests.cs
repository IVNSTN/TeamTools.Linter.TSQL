...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FieldNamePascalCaseRule))]
    public sealed class FieldNamePascalCaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FieldNamePascalCaseRuleTests));
        }
    }
}
