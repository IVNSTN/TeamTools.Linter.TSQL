...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IdSuffixForIntegerTypesOnlyRule))]
    public class IdSuffixForIntegerTypesOnlyRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IdSuffixForIntegerTypesOnlyRuleTests));
        }
    }
}
