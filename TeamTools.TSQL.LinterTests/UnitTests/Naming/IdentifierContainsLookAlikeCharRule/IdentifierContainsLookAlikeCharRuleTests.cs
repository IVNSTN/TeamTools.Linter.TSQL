...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IdentifierContainsLookAlikeCharRule))]
    public class IdentifierContainsLookAlikeCharRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IdentifierContainsLookAlikeCharRuleTests));
        }
    }
}
