...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(IndexNamePatternRule))]
    public sealed class IndexNamePatternRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IndexNamePatternRuleTests));
        }
    }
}
