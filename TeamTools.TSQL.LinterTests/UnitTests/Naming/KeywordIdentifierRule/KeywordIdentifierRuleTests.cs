...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(KeywordIdentifierRule))]
    public sealed class KeywordIdentifierRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(KeywordIdentifierRuleTests));
        }
    }
}
