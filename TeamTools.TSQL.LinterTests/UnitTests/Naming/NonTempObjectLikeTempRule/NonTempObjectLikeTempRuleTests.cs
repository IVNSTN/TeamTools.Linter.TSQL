...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NonTempObjectLikeTempRule))]
    public sealed class NonTempObjectLikeTempRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NonTempObjectLikeTempRuleTests));
        }
    }
}
