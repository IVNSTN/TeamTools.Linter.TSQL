...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ServiceBrokerPublicNameAsUrlRule))]
    public sealed class ServiceBrokerPublicNameAsUrlRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ServiceBrokerPublicNameAsUrlRuleTests));
        }
    }
}
