...
{
    [Category("Linter.TSQL.Naming")]
    [TestOfRule(typeof(ServiceBrokerPublicNameLowerSnakeCaseRule))]
    public sealed class ServiceBrokerPublicNameLowerSnakeCaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ServiceBrokerPublicNameLowerSnakeCaseRuleTests));
        }
    }
}
