...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ServiceBrokerPublicNamePascalCaseRule))]
    public sealed class ServiceBrokerPublicNamePascalCaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ServiceBrokerPublicNamePascalCaseRuleTests));
        }
    }
}
