...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SystemLikeObjectNamesRule))]
    public sealed class SystemLikeObjectNamesRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SystemLikeObjectNamesRuleTests));
        }
    }
}
