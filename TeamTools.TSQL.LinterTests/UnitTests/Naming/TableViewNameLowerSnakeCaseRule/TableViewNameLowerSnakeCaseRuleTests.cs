...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TableViewNameLowerSnakeCaseRule))]
    public sealed class TableViewNameLowerSnakeCaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TableViewNameLowerSnakeCaseRuleTests));
        }
    }
}
