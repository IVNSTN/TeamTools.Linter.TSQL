...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TableViewNamePascalCaseRule))]
    public sealed class TableViewNamePascalCaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TableViewNamePascalCaseRuleTests));
        }
    }
}
