...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TableViewNameUpperSnakeCaseRule))]
    public sealed class TableViewNameUpperSnakeCaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TableViewNameUpperSnakeCaseRuleTests));
        }
    }
}
