...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TriggerNamePatternRule))]
    public sealed class TriggerNamePatternRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TriggerNamePatternRuleTests));
        }
    }
}
