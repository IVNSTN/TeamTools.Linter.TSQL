...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UnreadableIdentifierRule))]
    public class UnreadableIdentifierRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UnreadableIdentifierRuleTests));
        }
    }
}
