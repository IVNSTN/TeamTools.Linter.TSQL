...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(VariableNameCamelCaseRule))]
    public sealed class VariableNameCamelCaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(VariableNameCamelCaseRuleTests));
        }
    }
}
