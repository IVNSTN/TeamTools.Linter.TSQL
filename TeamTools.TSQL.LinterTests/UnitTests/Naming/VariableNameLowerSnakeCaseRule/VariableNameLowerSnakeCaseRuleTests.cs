...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(VariableNameLowerSnakeCaseRule))]
    public sealed class VariableNameLowerSnakeCaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(VariableNameLowerSnakeCaseRuleTests));
        }
    }
}
