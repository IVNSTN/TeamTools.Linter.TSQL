...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(VariableNamePascalCaseRule))]
    public sealed class VariableNamePascalCaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(VariableNamePascalCaseRuleTests));
        }
    }
}
