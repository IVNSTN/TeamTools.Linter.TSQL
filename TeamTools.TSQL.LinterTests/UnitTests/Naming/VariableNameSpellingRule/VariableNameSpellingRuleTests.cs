...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(VariableNameSpellingRule))]
    public class VariableNameSpellingRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(VariableNameSpellingRuleTests));
        }
    }
}
