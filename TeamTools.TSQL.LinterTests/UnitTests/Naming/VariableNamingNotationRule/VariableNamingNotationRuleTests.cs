...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(VariableNamingNotationRule))]
    public class VariableNamingNotationRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(VariableNamingNotationRuleTests));
        }
    }
}
