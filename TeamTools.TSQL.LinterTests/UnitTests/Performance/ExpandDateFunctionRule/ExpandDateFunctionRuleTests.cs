...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ExpandDateFunctionRule))]
    public sealed class ExpandDateFunctionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ExpandDateFunctionRuleTests));
        }
    }
}
