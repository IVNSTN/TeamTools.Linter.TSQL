...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FightOptimizerByForcePlanRule))]
    public sealed class FightOptimizerByForcePlanRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FightOptimizerByForcePlanRuleTests));
        }
    }
}
