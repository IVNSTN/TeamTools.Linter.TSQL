...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FightOptimizerByJoinHintRule))]
    public sealed class FightOptimizerByJoinHintRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FightOptimizerByJoinHintRuleTests));
        }
    }
}
