...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FightOptimizerByQueryOptionRule))]
    public sealed class FightOptimizerByQueryOptionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FightOptimizerByQueryOptionRuleTests));
        }
    }
}
