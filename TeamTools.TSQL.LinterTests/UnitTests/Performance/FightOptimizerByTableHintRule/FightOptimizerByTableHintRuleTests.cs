...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(FightOptimizerByTableHintRule))]
    public sealed class FightOptimizerByTableHintRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(FightOptimizerByTableHintRuleTests));
        }
    }
}
