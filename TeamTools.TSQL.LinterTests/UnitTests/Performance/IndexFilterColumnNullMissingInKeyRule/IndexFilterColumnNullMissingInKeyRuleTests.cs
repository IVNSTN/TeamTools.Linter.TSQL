...
{
    [Category("Linter.TSQL.Performance")]
    [TestOfRule(typeof(IndexFilterColumnNullMissingInKeyRule))]
    public sealed class IndexFilterColumnNullMissingInKeyRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(IndexFilterColumnNullMissingInKeyRuleTests));
        }
    }
}
