...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(MultipleJoinsToCteRule))]
    public sealed class MultipleJoinsToCteRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(MultipleJoinsToCteRuleTests));
        }
    }
}
