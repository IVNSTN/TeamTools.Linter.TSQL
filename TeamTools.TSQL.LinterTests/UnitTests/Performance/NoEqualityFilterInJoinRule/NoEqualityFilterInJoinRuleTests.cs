...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NoEqualityFilterInJoinRule))]
    public sealed class NoEqualityFilterInJoinRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NoEqualityFilterInJoinRuleTests));
        }
    }
}
