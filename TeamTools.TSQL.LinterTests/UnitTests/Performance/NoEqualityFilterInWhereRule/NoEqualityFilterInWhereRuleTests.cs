...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NoEqualityFilterInWhereRule))]
    public sealed class NoEqualityFilterInWhereRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NoEqualityFilterInWhereRuleTests));
        }
    }
}
