...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NocountOptionInProcRule))]
    public class NocountOptionInProcRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NocountOptionInProcRuleTests));
        }
    }
}
