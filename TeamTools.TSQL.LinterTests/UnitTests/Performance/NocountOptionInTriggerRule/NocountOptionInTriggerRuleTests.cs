...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NocountOptionInTriggerRule))]
    public class NocountOptionInTriggerRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NocountOptionInTriggerRuleTests));
        }
    }
}
