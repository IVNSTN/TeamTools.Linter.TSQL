...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NonSargablePredicateRule))]
    public sealed class NonSargablePredicateRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NonSargablePredicateRuleTests));
        }
    }
}
