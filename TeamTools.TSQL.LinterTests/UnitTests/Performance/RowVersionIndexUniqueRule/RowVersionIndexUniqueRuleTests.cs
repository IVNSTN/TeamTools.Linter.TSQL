...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RowVersionIndexUniqueRule))]
    public class RowVersionIndexUniqueRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RowVersionIndexUniqueRuleTests));
        }
    }
}
