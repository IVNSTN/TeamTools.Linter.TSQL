...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SerialPlanForcedRule))]
    public sealed class SerialPlanForcedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SerialPlanForcedRuleTests));
        }
    }
}
