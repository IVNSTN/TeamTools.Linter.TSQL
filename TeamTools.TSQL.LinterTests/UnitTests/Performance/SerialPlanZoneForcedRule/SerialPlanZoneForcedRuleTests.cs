...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SerialPlanZoneForcedRule))]
    public sealed class SerialPlanZoneForcedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SerialPlanZoneForcedRuleTests));
        }
    }
}
