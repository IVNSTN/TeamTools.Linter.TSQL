...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SingleUserModeZoneForcedRule))]
    public sealed class SingleUserModeZoneForcedRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SingleUserModeZoneForcedRuleTests));
        }
    }
}
