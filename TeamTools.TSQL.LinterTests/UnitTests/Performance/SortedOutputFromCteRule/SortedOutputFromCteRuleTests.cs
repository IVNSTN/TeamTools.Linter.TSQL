...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SortedOutputFromCteRule))]
    public sealed class SortedOutputFromCteRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SortedOutputFromCteRuleTests));
        }
    }
}
