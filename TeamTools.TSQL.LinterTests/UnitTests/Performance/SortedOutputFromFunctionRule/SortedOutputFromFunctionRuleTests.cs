...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SortedOutputFromFunctionRule))]
    public sealed class SortedOutputFromFunctionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SortedOutputFromFunctionRuleTests));
        }
    }
}
