...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SortedOutputFromViewRule))]
    public sealed class SortedOutputFromViewRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SortedOutputFromViewRuleTests));
        }
    }
}
