...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SparseColumnIndexFilterRule))]
    public sealed class SparseColumnIndexFilterRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SparseColumnIndexFilterRuleTests));
        }
    }
}
