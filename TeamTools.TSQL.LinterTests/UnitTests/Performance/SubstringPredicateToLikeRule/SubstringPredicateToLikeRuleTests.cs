...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SubstringPredicateToLikeRule))]
    public sealed class SubstringPredicateToLikeRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SubstringPredicateToLikeRuleTests));
        }
    }
}
