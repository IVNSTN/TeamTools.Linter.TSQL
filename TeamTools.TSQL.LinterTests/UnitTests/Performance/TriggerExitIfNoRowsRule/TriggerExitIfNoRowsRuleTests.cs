...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(TriggerExitIfNoRowsRule))]
    public sealed class TriggerExitIfNoRowsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(TriggerExitIfNoRowsRuleTests));
        }
    }
}
