...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UniqueIndexOnColumnWithDefaultRule))]
    public class UniqueIndexOnColumnWithDefaultRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UniqueIndexOnColumnWithDefaultRuleTests));
        }
    }
}
