...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(BeginBeginEndEndRule))]
    public sealed class BeginBeginEndEndRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(BeginBeginEndEndRuleTests));
        }
    }
}
