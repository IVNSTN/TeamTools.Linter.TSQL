...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ColumnAliasSameAsSourceRule))]
    public sealed class ColumnAliasSameAsSourceRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ColumnAliasSameAsSourceRuleTests));
        }
    }
}
