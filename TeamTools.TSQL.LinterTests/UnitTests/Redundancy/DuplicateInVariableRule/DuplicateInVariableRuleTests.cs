...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DuplicateInVariableRule))]
    public sealed class DuplicateInVariableRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DuplicateInVariableRuleTests));
        }
    }
}
