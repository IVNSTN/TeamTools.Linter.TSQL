...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ExistsOutputControlRule))]
    public class ExistsOutputControlRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ExistsOutputControlRuleTests));
        }
    }
}
