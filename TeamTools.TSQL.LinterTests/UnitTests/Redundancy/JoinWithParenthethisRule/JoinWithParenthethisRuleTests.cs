...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(JoinWithParenthethisRule))]
    public sealed class JoinWithParenthethisRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(JoinWithParenthethisRuleTests));
        }
    }
}
