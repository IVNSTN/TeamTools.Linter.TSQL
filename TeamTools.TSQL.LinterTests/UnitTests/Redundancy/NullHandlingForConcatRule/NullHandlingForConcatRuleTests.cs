...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(NullHandlingForConcatRule))]
    public sealed class NullHandlingForConcatRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(NullHandlingForConcatRuleTests));
        }
    }
}
