...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantAggregationRule))]
    public sealed class RedundantAggregationRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantAggregationRuleTests));
        }
    }
}
