...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantAsteriskInMultilineCommentBlockRule))]
    public class RedundantAsteriskInMultilineCommentBlockRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantAsteriskInMultilineCommentBlockRuleTests));
        }
    }
}
