...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantBeginEndForElseRule))]
    public sealed class RedundantBeginEndForElseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantBeginEndForElseRuleTests));
        }
    }
}
