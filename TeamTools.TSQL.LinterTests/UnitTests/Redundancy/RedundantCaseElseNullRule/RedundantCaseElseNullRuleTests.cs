...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantCaseElseNullRule))]
    public class RedundantCaseElseNullRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantCaseElseNullRuleTests));
        }
    }
}
