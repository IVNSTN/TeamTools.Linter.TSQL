...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantCheckColNullabilityRule))]
    public sealed class RedundantCheckColNullabilityRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantCheckColNullabilityRuleTests));
        }
    }
}
