...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantContinueRule))]
    public sealed class RedundantContinueRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantContinueRuleTests));
        }
    }
}
