...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantDashAfterSingleLineCommentRule))]
    public class RedundantDashAfterSingleLineCommentRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantDashAfterSingleLineCommentRuleTests));
        }
    }
}
