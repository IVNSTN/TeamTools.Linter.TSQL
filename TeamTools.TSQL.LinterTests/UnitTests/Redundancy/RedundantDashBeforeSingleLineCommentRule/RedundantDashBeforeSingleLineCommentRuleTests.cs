...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantDashBeforeSingleLineCommentRule))]
    public class RedundantDashBeforeSingleLineCommentRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantDashBeforeSingleLineCommentRuleTests));
        }
    }
}
