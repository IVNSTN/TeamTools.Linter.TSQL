...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantFunctionArgumentRule))]
    public sealed class RedundantFunctionArgumentRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantFunctionArgumentRuleTests));
        }
    }
}
