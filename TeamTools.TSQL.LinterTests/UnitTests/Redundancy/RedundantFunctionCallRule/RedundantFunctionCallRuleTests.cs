...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantFunctionCallRule))]
    public class RedundantFunctionCallRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantFunctionCallRuleTests));
        }
    }
}
