...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantHavingUsageRule))]
    public class RedundantHavingUsageRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantHavingUsageRuleTests));
        }
    }
}
