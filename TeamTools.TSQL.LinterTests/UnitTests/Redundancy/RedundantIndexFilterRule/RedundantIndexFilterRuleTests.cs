...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantIndexFilterRule))]
    public sealed class RedundantIndexFilterRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantIndexFilterRuleTests));
        }
    }
}
