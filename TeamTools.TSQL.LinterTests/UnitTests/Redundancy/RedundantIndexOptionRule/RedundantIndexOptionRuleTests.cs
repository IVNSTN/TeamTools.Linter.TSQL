...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantIndexOptionRule))]
    public sealed class RedundantIndexOptionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantIndexOptionRuleTests));
        }
    }
}
