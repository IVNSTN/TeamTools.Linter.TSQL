...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantIntersectExceptRule))]
    public sealed class RedundantIntersectExceptRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantIntersectExceptRuleTests));
        }
    }
}
