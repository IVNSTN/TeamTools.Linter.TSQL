...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantIsNullForInequalityRule))]
    public sealed class RedundantIsNullForInequalityRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantIsNullForInequalityRuleTests));
        }
    }
}
