...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantLikePredicateRule))]
    public sealed class RedundantLikePredicateRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantLikePredicateRuleTests));
        }
    }
}
