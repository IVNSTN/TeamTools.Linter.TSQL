...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantNegationRule))]
    public sealed class RedundantNegationRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantNegationRuleTests));
        }
    }
}
