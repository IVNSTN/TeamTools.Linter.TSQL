...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantNestedCaseRule))]
    public sealed class RedundantNestedCaseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantNestedCaseRuleTests));
        }
    }
}
