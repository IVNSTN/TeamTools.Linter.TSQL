...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantNestedConditionRule))]
    public sealed class RedundantNestedConditionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantNestedConditionRuleTests));
        }
    }
}
