...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantNewLineAtEndOfFileRule))]
    public class RedundantNewLineAtEndOfFileRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantNewLineAtEndOfFileRuleTests));
        }
    }
}
