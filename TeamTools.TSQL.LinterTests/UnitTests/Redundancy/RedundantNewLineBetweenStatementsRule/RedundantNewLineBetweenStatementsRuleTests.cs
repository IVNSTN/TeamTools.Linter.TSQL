...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantNewLineBetweenStatementsRule))]
    public class RedundantNewLineBetweenStatementsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantNewLineBetweenStatementsRuleTests));
        }
    }
}
