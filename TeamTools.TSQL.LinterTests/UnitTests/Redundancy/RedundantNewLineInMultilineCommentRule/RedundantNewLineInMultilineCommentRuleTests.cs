...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantNewLineInMultilineCommentRule))]
    public class RedundantNewLineInMultilineCommentRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantNewLineInMultilineCommentRuleTests));
        }
    }
}
