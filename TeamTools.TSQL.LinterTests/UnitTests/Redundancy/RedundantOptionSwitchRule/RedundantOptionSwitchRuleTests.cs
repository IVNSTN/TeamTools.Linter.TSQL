...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantOptionSwitchRule))]
    public class RedundantOptionSwitchRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantOptionSwitchRuleTests));
        }
    }
}
