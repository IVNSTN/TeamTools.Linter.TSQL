...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantOrderByConstantRule))]
    public class RedundantOrderByConstantRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantOrderByConstantRuleTests));
        }
    }
}
