...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantParenthesisRule))]
    public sealed class RedundantParenthesisRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantParenthesisRuleTests));
        }
    }
}
