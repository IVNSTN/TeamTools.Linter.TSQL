...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantSelectScalarRule))]
    public class RedundantSelectScalarRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantSelectScalarRuleTests));
        }
    }
}
