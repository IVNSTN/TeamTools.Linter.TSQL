...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantSemicolonRule))]
    public sealed class RedundantSemicolonRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantSemicolonRuleTests));
        }
    }
}
