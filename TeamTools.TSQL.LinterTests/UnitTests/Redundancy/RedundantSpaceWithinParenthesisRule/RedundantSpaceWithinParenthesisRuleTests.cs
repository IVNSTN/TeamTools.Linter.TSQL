...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantSpaceWithinParenthesisRule))]
    public class RedundantSpaceWithinParenthesisRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantSpaceWithinParenthesisRuleTests));
        }
    }
}
