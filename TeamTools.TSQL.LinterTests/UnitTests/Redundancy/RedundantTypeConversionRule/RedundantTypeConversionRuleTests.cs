...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(RedundantTypeConversionRule))]
    public sealed class RedundantTypeConversionRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(RedundantTypeConversionRuleTests));
        }
    }
}
