...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ScalarPredicateTurnedIntoExistsRule))]
    public sealed class ScalarPredicateTurnedIntoExistsRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ScalarPredicateTurnedIntoExistsRuleTests));
        }
    }
}
