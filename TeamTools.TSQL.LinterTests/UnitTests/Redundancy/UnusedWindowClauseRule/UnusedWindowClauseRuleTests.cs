...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(UnusedWindowClauseRule))]
    public sealed class UnusedWindowClauseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(UnusedWindowClauseRuleTests));
        }
    }
}
