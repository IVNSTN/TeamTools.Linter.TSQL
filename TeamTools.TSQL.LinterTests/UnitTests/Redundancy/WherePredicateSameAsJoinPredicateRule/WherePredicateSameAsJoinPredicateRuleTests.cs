...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(WherePredicateSameAsJoinPredicateRule))]
    public sealed class WherePredicateSameAsJoinPredicateRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(WherePredicateSameAsJoinPredicateRuleTests));
        }
    }
}
