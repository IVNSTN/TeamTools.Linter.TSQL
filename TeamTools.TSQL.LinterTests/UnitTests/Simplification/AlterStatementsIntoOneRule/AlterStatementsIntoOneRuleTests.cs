...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(AlterStatementsIntoOneRule))]
    public sealed class AlterStatementsIntoOneRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(AlterStatementsIntoOneRuleTests));
        }
    }
}
