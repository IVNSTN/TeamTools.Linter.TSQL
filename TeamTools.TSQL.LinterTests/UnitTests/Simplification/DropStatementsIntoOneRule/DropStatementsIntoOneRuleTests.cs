...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(DropStatementsIntoOneRule))]
    public sealed class DropStatementsIntoOneRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(DropStatementsIntoOneRuleTests));
        }
    }
}
