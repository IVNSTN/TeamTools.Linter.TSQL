...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ExtractWindowClauseRule))]
    public sealed class ExtractWindowClauseRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ExtractWindowClauseRuleTests));
        }
    }
}
