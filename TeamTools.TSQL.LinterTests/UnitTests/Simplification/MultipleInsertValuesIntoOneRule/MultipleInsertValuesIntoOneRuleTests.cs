...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(MultipleInsertValuesIntoOneRule))]
    public sealed class MultipleInsertValuesIntoOneRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(MultipleInsertValuesIntoOneRuleTests));
        }
    }
}
