...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(MultipleNotInPredicateIntoOneRule))]
    public sealed class MultipleNotInPredicateIntoOneRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(MultipleNotInPredicateIntoOneRuleTests));
        }
    }
}
