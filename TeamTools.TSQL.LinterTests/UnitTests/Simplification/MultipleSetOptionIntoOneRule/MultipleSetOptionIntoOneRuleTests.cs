...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(MultipleSetOptionIntoOneRule))]
    public class MultipleSetOptionIntoOneRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(MultipleSetOptionIntoOneRuleTests));
        }
    }
}
