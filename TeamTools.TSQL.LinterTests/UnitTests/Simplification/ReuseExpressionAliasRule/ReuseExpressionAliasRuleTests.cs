...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(ReuseExpressionAliasRule))]
    public sealed class ReuseExpressionAliasRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(ReuseExpressionAliasRuleTests));
        }
    }
}
