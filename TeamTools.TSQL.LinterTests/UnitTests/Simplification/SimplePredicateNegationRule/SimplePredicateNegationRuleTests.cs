...
namespace TeamTools.TSQL.LinterTests
{
    ...
    [TestOfRule(typeof(SimplePredicateNegationRule))]
    public sealed class SimplePredicateNegationRuleTests : BaseRuleTest
    {
        ...
        {
            return GetTestSources(typeof(SimplePredicateNegationRuleTests));
        }
    }
}
